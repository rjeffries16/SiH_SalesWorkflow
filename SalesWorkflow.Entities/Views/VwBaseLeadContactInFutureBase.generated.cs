...
namespace SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwBaseLeadContactInFutureBase")]
	public abstract partial class VwBaseLeadContactInFutureBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwBaseLeadContactInFutureBase"/> instance.
		///</summary>
		public VwBaseLeadContactInFutureBase()
		{
		}		
		...
		{
			VwBaseLeadContactInFuture newVwBaseLeadContactInFuture = new VwBaseLeadContactInFuture();
			newVwBaseLeadContactInFuture.CreatedBy = _createdBy;
			newVwBaseLeadContactInFuture.CreatedTime = _createdTime;
			newVwBaseLeadContactInFuture.FirstName = _firstName;
			newVwBaseLeadContactInFuture.LastName = _lastName;
			newVwBaseLeadContactInFuture.IfNoLongerInterested = _ifNoLongerInterested;
			newVwBaseLeadContactInFuture.LastActivityTime = _lastActivityTime;
			newVwBaseLeadContactInFuture.LastVisitedTime = _lastVisitedTime;
			newVwBaseLeadContactInFuture.LeadOwner = _leadOwner;
			newVwBaseLeadContactInFuture.LeadSource = _leadSource;
			newVwBaseLeadContactInFuture.LeadStatus = _leadStatus;
			newVwBaseLeadContactInFuture.Leadid = _leadid;
			newVwBaseLeadContactInFuture.Rating = _rating;
			newVwBaseLeadContactInFuture.State = _state;
			newVwBaseLeadContactInFuture.TimeZone = _timeZone;
			newVwBaseLeadContactInFuture.LocalTime = _localTime;
			newVwBaseLeadContactInFuture.Url = _url;
			newVwBaseLeadContactInFuture.Website = _website;
			newVwBaseLeadContactInFuture.Worries = _worries;
			newVwBaseLeadContactInFuture.Leadpk = _leadpk;
			newVwBaseLeadContactInFuture.Wday811 = _wday811;
			newVwBaseLeadContactInFuture.Wday112 = _wday112;
			newVwBaseLeadContactInFuture.Wday25 = _wday25;
			newVwBaseLeadContactInFuture.Wday58 = _wday58;
			newVwBaseLeadContactInFuture.Sat811 = _sat811;
			newVwBaseLeadContactInFuture.Sat112 = _sat112;
			newVwBaseLeadContactInFuture.Sat25 = _sat25;
			newVwBaseLeadContactInFuture.Sat58 = _sat58;
			newVwBaseLeadContactInFuture.Sun811 = _sun811;
			newVwBaseLeadContactInFuture.Sun112 = _sun112;
			newVwBaseLeadContactInFuture.Sun25 = _sun25;
			newVwBaseLeadContactInFuture.Sun58 = _sun58;
			newVwBaseLeadContactInFuture.LeadOwnerId = _leadOwnerId;
			newVwBaseLeadContactInFuture.TotalCalls = _totalCalls;
			return newVwBaseLeadContactInFuture;
		}
		...
		{
			get { return "vw_BaseLeadContactInFuture"; }
		}
		...
		///<summary>
		///  Returns a Typed VwBaseLeadContactInFutureBase Entity 
		///</summary>
		public virtual VwBaseLeadContactInFutureBase Copy()
		{
			//shallow copy entity
			VwBaseLeadContactInFuture copy = new VwBaseLeadContactInFuture();
			...
			copy.AcceptChanges();
			return (VwBaseLeadContactInFuture)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwBaseLeadContactInFutureBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwBaseLeadContactInFutureBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwBaseLeadContactInFutureBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwBaseLeadContactInFutureBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwBaseLeadContactInFutureBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwBaseLeadContactInFutureBase Object1, VwBaseLeadContactInFutureBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwBaseLeadContactInFuture entity, string propertyName)
		{
			switch (propertyName)
			{
				case "CreatedBy":
		...
		{			
			return GetPropertyValueByName(this as VwBaseLeadContactInFuture, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VwBaseLeadContactInFuture columns.
	/// </summary>
	[Serializable]
	public enum VwBaseLeadContactInFutureColumn
	{
		/// <summary>
		/// Created By : 
		/// </summary>
