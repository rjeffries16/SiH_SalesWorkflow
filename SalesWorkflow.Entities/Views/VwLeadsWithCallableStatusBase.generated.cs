...
namespace SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwLeadsWithCallableStatusBase")]
	public abstract partial class VwLeadsWithCallableStatusBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwLeadsWithCallableStatusBase"/> instance.
		///</summary>
		public VwLeadsWithCallableStatusBase()
		{
		}		
		...
		{
			VwLeadsWithCallableStatus newVwLeadsWithCallableStatus = new VwLeadsWithCallableStatus();
			newVwLeadsWithCallableStatus.LeadStatus = _leadStatus;
			newVwLeadsWithCallableStatus.Leadid = _leadid;
			newVwLeadsWithCallableStatus.CreatedTime = _createdTime;
			newVwLeadsWithCallableStatus.Email = _email;
			newVwLeadsWithCallableStatus.FirstName = _firstName;
			newVwLeadsWithCallableStatus.LastName = _lastName;
			newVwLeadsWithCallableStatus.IfNoLongerInterested = _ifNoLongerInterested;
			newVwLeadsWithCallableStatus.LastActivityTime = _lastActivityTime;
			newVwLeadsWithCallableStatus.LastVisitedTime = _lastVisitedTime;
			newVwLeadsWithCallableStatus.LeadOwner = _leadOwner;
			newVwLeadsWithCallableStatus.Rating = _rating;
			newVwLeadsWithCallableStatus.State = _state;
			newVwLeadsWithCallableStatus.TimeZone = _timeZone;
			newVwLeadsWithCallableStatus.Phone = _phone;
			newVwLeadsWithCallableStatus.LeadHoldDts = _leadHoldDts;
			newVwLeadsWithCallableStatus.LeadActionDts = _leadActionDts;
			return newVwLeadsWithCallableStatus;
		}
		...
		{
			get { return "vw_LeadsWithCallableStatus"; }
		}
		...
		///<summary>
		///  Returns a Typed VwLeadsWithCallableStatusBase Entity 
		///</summary>
		public virtual VwLeadsWithCallableStatusBase Copy()
		{
			//shallow copy entity
			VwLeadsWithCallableStatus copy = new VwLeadsWithCallableStatus();
			...
			copy.AcceptChanges();
			return (VwLeadsWithCallableStatus)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwLeadsWithCallableStatusBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwLeadsWithCallableStatusBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwLeadsWithCallableStatusBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwLeadsWithCallableStatusBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwLeadsWithCallableStatusBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwLeadsWithCallableStatusBase Object1, VwLeadsWithCallableStatusBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwLeadsWithCallableStatus entity, string propertyName)
		{
			switch (propertyName)
			{
				case "LeadStatus":
		...
		{			
			return GetPropertyValueByName(this as VwLeadsWithCallableStatus, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VwLeadsWithCallableStatus columns.
	/// </summary>
	[Serializable]
	public enum VwLeadsWithCallableStatusColumn
	{
		/// <summary>
		/// Lead Status : 
		/// </summary>
