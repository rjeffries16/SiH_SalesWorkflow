...
namespace SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwBaseLeadGetZeroCallsInPeriodBase")]
	public abstract partial class VwBaseLeadGetZeroCallsInPeriodBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwBaseLeadGetZeroCallsInPeriodBase"/> instance.
		///</summary>
		public VwBaseLeadGetZeroCallsInPeriodBase()
		{
		}		
		...
		{
			VwBaseLeadGetZeroCallsInPeriod newVwBaseLeadGetZeroCallsInPeriod = new VwBaseLeadGetZeroCallsInPeriod();
			newVwBaseLeadGetZeroCallsInPeriod.CreatedBy = _createdBy;
			newVwBaseLeadGetZeroCallsInPeriod.CreatedTime = _createdTime;
			newVwBaseLeadGetZeroCallsInPeriod.FirstName = _firstName;
			newVwBaseLeadGetZeroCallsInPeriod.LastName = _lastName;
			newVwBaseLeadGetZeroCallsInPeriod.IfNoLongerInterested = _ifNoLongerInterested;
			newVwBaseLeadGetZeroCallsInPeriod.LastActivityTime = _lastActivityTime;
			newVwBaseLeadGetZeroCallsInPeriod.LastVisitedTime = _lastVisitedTime;
			newVwBaseLeadGetZeroCallsInPeriod.LeadOwner = _leadOwner;
			newVwBaseLeadGetZeroCallsInPeriod.LeadSource = _leadSource;
			newVwBaseLeadGetZeroCallsInPeriod.LeadStatus = _leadStatus;
			newVwBaseLeadGetZeroCallsInPeriod.Leadid = _leadid;
			newVwBaseLeadGetZeroCallsInPeriod.Rating = _rating;
			newVwBaseLeadGetZeroCallsInPeriod.State = _state;
			newVwBaseLeadGetZeroCallsInPeriod.TimeZone = _timeZone;
			newVwBaseLeadGetZeroCallsInPeriod.LocalTime = _localTime;
			newVwBaseLeadGetZeroCallsInPeriod.Url = _url;
			newVwBaseLeadGetZeroCallsInPeriod.Website = _website;
			newVwBaseLeadGetZeroCallsInPeriod.Worries = _worries;
			newVwBaseLeadGetZeroCallsInPeriod.Leadpk = _leadpk;
			newVwBaseLeadGetZeroCallsInPeriod.Wday811 = _wday811;
			newVwBaseLeadGetZeroCallsInPeriod.Wday112 = _wday112;
			newVwBaseLeadGetZeroCallsInPeriod.Wday25 = _wday25;
			newVwBaseLeadGetZeroCallsInPeriod.Wday58 = _wday58;
			newVwBaseLeadGetZeroCallsInPeriod.Sat811 = _sat811;
			newVwBaseLeadGetZeroCallsInPeriod.Sat112 = _sat112;
			newVwBaseLeadGetZeroCallsInPeriod.Sat25 = _sat25;
			newVwBaseLeadGetZeroCallsInPeriod.Sat58 = _sat58;
			newVwBaseLeadGetZeroCallsInPeriod.Sun811 = _sun811;
			newVwBaseLeadGetZeroCallsInPeriod.Sun112 = _sun112;
			newVwBaseLeadGetZeroCallsInPeriod.Sun25 = _sun25;
			newVwBaseLeadGetZeroCallsInPeriod.Sun58 = _sun58;
			newVwBaseLeadGetZeroCallsInPeriod.LeadOwnerId = _leadOwnerId;
			newVwBaseLeadGetZeroCallsInPeriod.TotalCalls = _totalCalls;
			return newVwBaseLeadGetZeroCallsInPeriod;
		}
		...
		{
			get { return "vw_BaseLeadGetZeroCallsInPeriod"; }
		}
		...
		///<summary>
		///  Returns a Typed VwBaseLeadGetZeroCallsInPeriodBase Entity 
		///</summary>
		public virtual VwBaseLeadGetZeroCallsInPeriodBase Copy()
		{
			//shallow copy entity
			VwBaseLeadGetZeroCallsInPeriod copy = new VwBaseLeadGetZeroCallsInPeriod();
			...
			copy.AcceptChanges();
			return (VwBaseLeadGetZeroCallsInPeriod)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwBaseLeadGetZeroCallsInPeriodBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwBaseLeadGetZeroCallsInPeriodBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwBaseLeadGetZeroCallsInPeriodBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwBaseLeadGetZeroCallsInPeriodBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwBaseLeadGetZeroCallsInPeriodBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwBaseLeadGetZeroCallsInPeriodBase Object1, VwBaseLeadGetZeroCallsInPeriodBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwBaseLeadGetZeroCallsInPeriod entity, string propertyName)
		{
			switch (propertyName)
			{
				case "CreatedBy":
		...
		{			
			return GetPropertyValueByName(this as VwBaseLeadGetZeroCallsInPeriod, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VwBaseLeadGetZeroCallsInPeriod columns.
	/// </summary>
	[Serializable]
	public enum VwBaseLeadGetZeroCallsInPeriodColumn
	{
		/// <summary>
		/// Created By : 
		/// </summary>
