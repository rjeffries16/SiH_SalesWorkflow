...
namespace SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwCallableLeadsWithCallsAndPeriodBase")]
	public abstract partial class VwCallableLeadsWithCallsAndPeriodBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// PERIOD : 
		/// </summary>
		private System.String		  _period = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwCallableLeadsWithCallsAndPeriodBase"/> instance.
		///</summary>
		public VwCallableLeadsWithCallsAndPeriodBase()
		{
		}		
		...
		{
			VwCallableLeadsWithCallsAndPeriod newVwCallableLeadsWithCallsAndPeriod = new VwCallableLeadsWithCallsAndPeriod();
			newVwCallableLeadsWithCallsAndPeriod.Leadid = _leadid;
			newVwCallableLeadsWithCallsAndPeriod.FirstName = _firstName;
			newVwCallableLeadsWithCallsAndPeriod.LastName = _lastName;
			newVwCallableLeadsWithCallsAndPeriod.Phone = _phone;
			newVwCallableLeadsWithCallsAndPeriod.CallStartTime = _callStartTime;
			newVwCallableLeadsWithCallsAndPeriod.Hour = _hour;
			newVwCallableLeadsWithCallsAndPeriod.Daytype = _daytype;
			newVwCallableLeadsWithCallsAndPeriod.TimeZone = _timeZone;
			newVwCallableLeadsWithCallsAndPeriod.HourAdj = _hourAdj;
			newVwCallableLeadsWithCallsAndPeriod.Period = _period;
			newVwCallableLeadsWithCallsAndPeriod.CreatedTime = _createdTime;
			return newVwCallableLeadsWithCallsAndPeriod;
		}
		...
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.String Period
		{
			get
			{
				return this._period; 
		...
		{
			get { return "vw_CallableLeadsWithCallsAndPeriod"; }
		}
		...
		///<summary>
		///  Returns a Typed VwCallableLeadsWithCallsAndPeriodBase Entity 
		///</summary>
		public virtual VwCallableLeadsWithCallsAndPeriodBase Copy()
		{
			//shallow copy entity
			VwCallableLeadsWithCallsAndPeriod copy = new VwCallableLeadsWithCallsAndPeriod();
			...
			copy.AcceptChanges();
			return (VwCallableLeadsWithCallsAndPeriod)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwCallableLeadsWithCallsAndPeriodBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwCallableLeadsWithCallsAndPeriodBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwCallableLeadsWithCallsAndPeriodBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwCallableLeadsWithCallsAndPeriodBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwCallableLeadsWithCallsAndPeriodBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwCallableLeadsWithCallsAndPeriodBase Object1, VwCallableLeadsWithCallsAndPeriodBase Object2)
		{
			// both are null
			...
			if (Object1.Period != null && Object2.Period != null )
			{
				if (Object1.Period != Object2.Period)
					equal = false;
			}
			else if (Object1.Period == null ^ Object1.Period == null )
			{
				equal = false;
			}
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwCallableLeadsWithCallsAndPeriod entity, string propertyName)
		{
			switch (propertyName)
			{
				case "Leadid":
		...
		{			
			return GetPropertyValueByName(this as VwCallableLeadsWithCallsAndPeriod, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{12}{11}- Leadid: {0}{11}- FirstName: {1}{11}- LastName: {2}{11}- Phone: {3}{11}- CallStartTime: {4}{11}- Hour: {5}{11}- Daytype: {6}{11}- TimeZone: {7}{11}- HourAdj: {8}{11}- Period: {9}{11}- CreatedTime: {10}{11}", 
				...
				(this.Period == null) ? string.Empty : this.Period.ToString(),
	...
	/// <summary>
	/// Enumerate the VwCallableLeadsWithCallsAndPeriod columns.
	/// </summary>
	[Serializable]
	public enum VwCallableLeadsWithCallsAndPeriodColumn
	{
		/// <summary>
		/// LEADID : 
		/// </summary>
		...
		/// PERIOD : 
		/// </summary>
		[EnumTextValue("PERIOD")]
		[ColumnEnum("PERIOD", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 5)]
		Period,
		/// <summary>
		/// Created Time : 
		/// </summary>
