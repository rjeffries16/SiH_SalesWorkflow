...
namespace SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwLeadCallCountsBase")]
	public abstract partial class VwLeadCallCountsBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwLeadCallCountsBase"/> instance.
		///</summary>
		public VwLeadCallCountsBase()
		{
		}		
		...
		public VwLeadCallCountsBase(System.String _leadid, System.String _lastName, System.String _firstName, System.Int32? _callCount, System.DateTime? _createdTime, System.String _leadStatus, System.String _rating, System.String _leadOwner)
		{
		...
		{
			VwLeadCallCounts newVwLeadCallCounts = new VwLeadCallCounts();
			newVwLeadCallCounts.Leadid = _leadid;
			newVwLeadCallCounts.LastName = _lastName;
			newVwLeadCallCounts.FirstName = _firstName;
			newVwLeadCallCounts.CallCount = _callCount;
			newVwLeadCallCounts.CreatedTime = _createdTime;
			newVwLeadCallCounts.LeadStatus = _leadStatus;
			newVwLeadCallCounts.Rating = _rating;
			newVwLeadCallCounts.LeadOwner = _leadOwner;
			return newVwLeadCallCounts;
		}
		...
		/// <summary>
		/// 	Gets or Sets the Call Count property. 
		///		
		/// </summary>
		...
		///<summary>
		///  Returns a Typed VwLeadCallCountsBase Entity 
		///</summary>
		public virtual VwLeadCallCountsBase Copy()
		{
			//shallow copy entity
			VwLeadCallCounts copy = new VwLeadCallCounts();
		...
		///<returns>true if toObject is a <see cref="VwLeadCallCountsBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwLeadCallCountsBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwLeadCallCountsBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwLeadCallCountsBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwLeadCallCountsBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwLeadCallCountsBase Object1, VwLeadCallCountsBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwLeadCallCounts entity, string propertyName)
		{
			switch (propertyName)
			{
				case "Leadid":
		...
		{			
			return GetPropertyValueByName(this as VwLeadCallCounts, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{9}{8}- Leadid: {0}{8}- LastName: {1}{8}- FirstName: {2}{8}- CallCount: {3}{8}- CreatedTime: {4}{8}- LeadStatus: {5}{8}- Rating: {6}{8}- LeadOwner: {7}{8}", 
	...
	/// <summary>
	/// Enumerate the VwLeadCallCounts columns.
	/// </summary>
	[Serializable]
	public enum VwLeadCallCountsColumn
	{
		/// <summary>
		/// LEADID : 
		/// </summary>
		...
		/// Call Count : 
		/// </summary>
		[EnumTextValue("Call Count")]
		[ColumnEnum("Call Count", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		CallCount,
		/// <summary>
		/// Created Time : 
		/// </summary>
