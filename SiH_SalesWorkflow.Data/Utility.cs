...
namespace SiH_SalesWorkflow.Data
{
	...
	public sealed class Utility
	{
		#region Fields
		//PSB 2006-05-26: should we use EntLib ExceptionPolicy.HandleException?
		//private const string exceptionPolicy = "SiH_SalesWorkflow.Data Exception Policy";
		#endregion
		...
		public static String ParseSortExpression(Type columnEnum, String sortExpression)
		{
			...
			{
				sort = String.Format("[{0}]", EntityHelper.GetAttribute<ColumnEnumAttribute>((Enum)Enum.Parse(columnEnum, Enum.GetName(columnEnum, 1), true)).Name);
			}
