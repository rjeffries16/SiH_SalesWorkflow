...
{	
	...
	///</summary>
	public abstract partial class LeadContactedProviderBaseCore : EntityProviderBase<SiH_SalesWorkflow.Entities.LeadContacted, SiH_SalesWorkflow.Entities.LeadContactedKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, SiH_SalesWorkflow.Entities.LeadContactedKey key)
		{
		...
		public override SiH_SalesWorkflow.Entities.LeadContacted Get(TransactionManager transactionManager, SiH_SalesWorkflow.Entities.LeadContactedKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> class.</returns>
		public SiH_SalesWorkflow.Entities.LeadContacted GetByLeadContactedPk(System.Int64 _leadContactedPk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> class.</returns>
		public SiH_SalesWorkflow.Entities.LeadContacted GetByLeadContactedPk(System.Int64 _leadContactedPk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> class.</returns>
		public SiH_SalesWorkflow.Entities.LeadContacted GetByLeadContactedPk(TransactionManager transactionManager, System.Int64 _leadContactedPk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> class.</returns>
		public SiH_SalesWorkflow.Entities.LeadContacted GetByLeadContactedPk(TransactionManager transactionManager, System.Int64 _leadContactedPk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> class.</returns>
		public SiH_SalesWorkflow.Entities.LeadContacted GetByLeadContactedPk(System.Int64 _leadContactedPk, int start, int pageLength, out int count)
		{
			return GetByLeadContactedPk(null, _leadContactedPk, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> class.</returns>
		public abstract SiH_SalesWorkflow.Entities.LeadContacted GetByLeadContactedPk(TransactionManager transactionManager, System.Int64 _leadContactedPk, int start, int pageLength, out int count);
		...
		public static TList<LeadContacted> Fill(IDataReader reader, TList<LeadContacted> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				SiH_SalesWorkflow.Entities.LeadContacted c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new SiH_SalesWorkflow.Entities.LeadContacted();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, SiH_SalesWorkflow.Entities.LeadContacted entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, SiH_SalesWorkflow.Entities.LeadContacted entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="SiH_SalesWorkflow.Entities.LeadContacted"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">SiH_SalesWorkflow.Entities.LeadContacted Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, SiH_SalesWorkflow.Entities.LeadContacted entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the SiH_SalesWorkflow.Entities.LeadContacted object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">SiH_SalesWorkflow.Entities.LeadContacted instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">SiH_SalesWorkflow.Entities.LeadContacted Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, SiH_SalesWorkflow.Entities.LeadContacted entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>SiH_SalesWorkflow.Entities.LeadContacted</c>
	///</summary>
