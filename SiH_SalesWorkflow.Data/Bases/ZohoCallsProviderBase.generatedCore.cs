...
{	
	...
	///</summary>
	public abstract partial class ZohoCallsProviderBaseCore : EntityProviderBase<SiH_SalesWorkflow.Entities.ZohoCalls, SiH_SalesWorkflow.Entities.ZohoCallsKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, SiH_SalesWorkflow.Entities.ZohoCallsKey key)
		{
		...
		public override SiH_SalesWorkflow.Entities.ZohoCalls Get(TransactionManager transactionManager, SiH_SalesWorkflow.Entities.ZohoCallsKey key, int start, int pageLength)
		{
		...
		public SiH_SalesWorkflow.Entities.ZohoCalls GetByCallPk(System.Int64 _callPk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> class.</returns>
		public SiH_SalesWorkflow.Entities.ZohoCalls GetByCallPk(System.Int64 _callPk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> class.</returns>
		public SiH_SalesWorkflow.Entities.ZohoCalls GetByCallPk(TransactionManager transactionManager, System.Int64 _callPk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> class.</returns>
		public SiH_SalesWorkflow.Entities.ZohoCalls GetByCallPk(TransactionManager transactionManager, System.Int64 _callPk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> class.</returns>
		public SiH_SalesWorkflow.Entities.ZohoCalls GetByCallPk(System.Int64 _callPk, int start, int pageLength, out int count)
		{
			return GetByCallPk(null, _callPk, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> class.</returns>
		public abstract SiH_SalesWorkflow.Entities.ZohoCalls GetByCallPk(TransactionManager transactionManager, System.Int64 _callPk, int start, int pageLength, out int count);
		...
		public static TList<ZohoCalls> Fill(IDataReader reader, TList<ZohoCalls> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				SiH_SalesWorkflow.Entities.ZohoCalls c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new SiH_SalesWorkflow.Entities.ZohoCalls();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, SiH_SalesWorkflow.Entities.ZohoCalls entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, SiH_SalesWorkflow.Entities.ZohoCalls entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="SiH_SalesWorkflow.Entities.ZohoCalls"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">SiH_SalesWorkflow.Entities.ZohoCalls Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, SiH_SalesWorkflow.Entities.ZohoCalls entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the SiH_SalesWorkflow.Entities.ZohoCalls object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">SiH_SalesWorkflow.Entities.ZohoCalls instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">SiH_SalesWorkflow.Entities.ZohoCalls Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, SiH_SalesWorkflow.Entities.ZohoCalls entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>SiH_SalesWorkflow.Entities.ZohoCalls</c>
	///</summary>
