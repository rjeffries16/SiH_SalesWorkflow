...
namespace SiH_SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwZohoLeadsWithLocalTimeNoActionTodayCallableBase")]
	public abstract partial class VwZohoLeadsWithLocalTimeNoActionTodayCallableBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwZohoLeadsWithLocalTimeNoActionTodayCallableBase"/> instance.
		///</summary>
		public VwZohoLeadsWithLocalTimeNoActionTodayCallableBase()
		{
		}		
		...
		{
			VwZohoLeadsWithLocalTimeNoActionTodayCallable newVwZohoLeadsWithLocalTimeNoActionTodayCallable = new VwZohoLeadsWithLocalTimeNoActionTodayCallable();
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.CreatedBy = _createdBy;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.CreatedTime = _createdTime;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.FirstName = _firstName;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LastName = _lastName;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.IfNoLongerInterested = _ifNoLongerInterested;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LastActivityTime = _lastActivityTime;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LastVisitedTime = _lastVisitedTime;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LeadOwner = _leadOwner;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LeadSource = _leadSource;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LeadStatus = _leadStatus;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Leadid = _leadid;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Rating = _rating;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.State = _state;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.TimeZone = _timeZone;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LocalTime = _localTime;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Url = _url;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Website = _website;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Worries = _worries;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Leadpk = _leadpk;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Wday811 = _wday811;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Wday112 = _wday112;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Wday25 = _wday25;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Wday58 = _wday58;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Sat811 = _sat811;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Sat112 = _sat112;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Sat25 = _sat25;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Sat58 = _sat58;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Sun112 = _sun112;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Sun811 = _sun811;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Sun25 = _sun25;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.Sun58 = _sun58;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.UserId = _userId;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LeadHoldDts = _leadHoldDts;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LeadCalled = _leadCalled;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LeadDefered = _leadDefered;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LeadActionDts = _leadActionDts;
			newVwZohoLeadsWithLocalTimeNoActionTodayCallable.LeadOwnerId = _leadOwnerId;
			return newVwZohoLeadsWithLocalTimeNoActionTodayCallable;
		}
		...
		{
			get { return "vw_ZohoLeadsWithLocalTimeNoActionTodayCallable"; }
		}
		...
		///<summary>
		///  Returns a Typed VwZohoLeadsWithLocalTimeNoActionTodayCallableBase Entity 
		///</summary>
		public virtual VwZohoLeadsWithLocalTimeNoActionTodayCallableBase Copy()
		{
			//shallow copy entity
			VwZohoLeadsWithLocalTimeNoActionTodayCallable copy = new VwZohoLeadsWithLocalTimeNoActionTodayCallable();
			...
			copy.AcceptChanges();
			return (VwZohoLeadsWithLocalTimeNoActionTodayCallable)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwZohoLeadsWithLocalTimeNoActionTodayCallableBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwZohoLeadsWithLocalTimeNoActionTodayCallableBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwZohoLeadsWithLocalTimeNoActionTodayCallableBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwZohoLeadsWithLocalTimeNoActionTodayCallableBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwZohoLeadsWithLocalTimeNoActionTodayCallableBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwZohoLeadsWithLocalTimeNoActionTodayCallableBase Object1, VwZohoLeadsWithLocalTimeNoActionTodayCallableBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwZohoLeadsWithLocalTimeNoActionTodayCallable entity, string propertyName)
		{
			switch (propertyName)
			{
				case "CreatedBy":
		...
		{			
			return GetPropertyValueByName(this as VwZohoLeadsWithLocalTimeNoActionTodayCallable, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{38}{37}- CreatedBy: {0}{37}- CreatedTime: {1}{37}- FirstName: {2}{37}- LastName: {3}{37}- IfNoLongerInterested: {4}{37}- LastActivityTime: {5}{37}- LastVisitedTime: {6}{37}- LeadOwner: {7}{37}- LeadSource: {8}{37}- LeadStatus: {9}{37}- Leadid: {10}{37}- Rating: {11}{37}- State: {12}{37}- TimeZone: {13}{37}- LocalTime: {14}{37}- Url: {15}{37}- Website: {16}{37}- Worries: {17}{37}- Leadpk: {18}{37}- Wday811: {19}{37}- Wday112: {20}{37}- Wday25: {21}{37}- Wday58: {22}{37}- Sat811: {23}{37}- Sat112: {24}{37}- Sat25: {25}{37}- Sat58: {26}{37}- Sun112: {27}{37}- Sun811: {28}{37}- Sun25: {29}{37}- Sun58: {30}{37}- UserId: {31}{37}- LeadHoldDts: {32}{37}- LeadCalled: {33}{37}- LeadDefered: {34}{37}- LeadActionDts: {35}{37}- LeadOwnerId: {36}{37}", 
	...
	/// <summary>
	/// Enumerate the VwZohoLeadsWithLocalTimeNoActionTodayCallable columns.
	/// </summary>
	[Serializable]
	public enum VwZohoLeadsWithLocalTimeNoActionTodayCallableColumn
	{
		/// <summary>
		/// Created By : 
		/// </summary>
