...
namespace SiH_SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwLeadContactToolBase")]
	public abstract partial class VwLeadContactToolBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwLeadContactToolBase"/> instance.
		///</summary>
		public VwLeadContactToolBase()
		{
		}		
		...
		public VwLeadContactToolBase(System.String _firstName, System.String _lastName, System.String _lastVisitedTime, System.String _leadOwner, System.String _leadid, System.DateTime? _createdTime)
		{
		...
		{
			VwLeadContactTool newVwLeadContactTool = new VwLeadContactTool();
			newVwLeadContactTool.FirstName = _firstName;
			newVwLeadContactTool.LastName = _lastName;
			newVwLeadContactTool.LastVisitedTime = _lastVisitedTime;
			newVwLeadContactTool.LeadOwner = _leadOwner;
			newVwLeadContactTool.Leadid = _leadid;
			newVwLeadContactTool.CreatedTime = _createdTime;
			return newVwLeadContactTool;
		}
		...
		///<summary>
		///  Returns a Typed VwLeadContactToolBase Entity 
		///</summary>
		public virtual VwLeadContactToolBase Copy()
		{
			//shallow copy entity
			VwLeadContactTool copy = new VwLeadContactTool();
		...
		///<returns>true if toObject is a <see cref="VwLeadContactToolBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwLeadContactToolBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwLeadContactToolBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwLeadContactToolBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwLeadContactToolBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwLeadContactToolBase Object1, VwLeadContactToolBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwLeadContactTool entity, string propertyName)
		{
			switch (propertyName)
			{
				case "FirstName":
		...
		{			
			return GetPropertyValueByName(this as VwLeadContactTool, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{7}{6}- FirstName: {0}{6}- LastName: {1}{6}- LastVisitedTime: {2}{6}- LeadOwner: {3}{6}- Leadid: {4}{6}- CreatedTime: {5}{6}", 
	...
	/// <summary>
	/// Enumerate the VwLeadContactTool columns.
	/// </summary>
	[Serializable]
	public enum VwLeadContactToolColumn
	{
		/// <summary>
		/// First Name : 
		/// </summary>
