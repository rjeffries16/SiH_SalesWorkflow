...
namespace SiH_SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwBaseLeadGetWithNoActivityInNdaysBase")]
	public abstract partial class VwBaseLeadGetWithNoActivityInNdaysBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwBaseLeadGetWithNoActivityInNdaysBase"/> instance.
		///</summary>
		public VwBaseLeadGetWithNoActivityInNdaysBase()
		{
		}		
		...
		{
			VwBaseLeadGetWithNoActivityInNdays newVwBaseLeadGetWithNoActivityInNdays = new VwBaseLeadGetWithNoActivityInNdays();
			newVwBaseLeadGetWithNoActivityInNdays.CreatedBy = _createdBy;
			newVwBaseLeadGetWithNoActivityInNdays.CreatedTime = _createdTime;
			newVwBaseLeadGetWithNoActivityInNdays.FirstName = _firstName;
			newVwBaseLeadGetWithNoActivityInNdays.LastName = _lastName;
			newVwBaseLeadGetWithNoActivityInNdays.IfNoLongerInterested = _ifNoLongerInterested;
			newVwBaseLeadGetWithNoActivityInNdays.LastActivityTime = _lastActivityTime;
			newVwBaseLeadGetWithNoActivityInNdays.LastVisitedTime = _lastVisitedTime;
			newVwBaseLeadGetWithNoActivityInNdays.LeadOwner = _leadOwner;
			newVwBaseLeadGetWithNoActivityInNdays.LeadSource = _leadSource;
			newVwBaseLeadGetWithNoActivityInNdays.LeadStatus = _leadStatus;
			newVwBaseLeadGetWithNoActivityInNdays.Leadid = _leadid;
			newVwBaseLeadGetWithNoActivityInNdays.Rating = _rating;
			newVwBaseLeadGetWithNoActivityInNdays.State = _state;
			newVwBaseLeadGetWithNoActivityInNdays.TimeZone = _timeZone;
			newVwBaseLeadGetWithNoActivityInNdays.LocalTime = _localTime;
			newVwBaseLeadGetWithNoActivityInNdays.Url = _url;
			newVwBaseLeadGetWithNoActivityInNdays.Website = _website;
			newVwBaseLeadGetWithNoActivityInNdays.Worries = _worries;
			newVwBaseLeadGetWithNoActivityInNdays.Leadpk = _leadpk;
			newVwBaseLeadGetWithNoActivityInNdays.Wday811 = _wday811;
			newVwBaseLeadGetWithNoActivityInNdays.Wday112 = _wday112;
			newVwBaseLeadGetWithNoActivityInNdays.Wday25 = _wday25;
			newVwBaseLeadGetWithNoActivityInNdays.Wday58 = _wday58;
			newVwBaseLeadGetWithNoActivityInNdays.Sat811 = _sat811;
			newVwBaseLeadGetWithNoActivityInNdays.Sat112 = _sat112;
			newVwBaseLeadGetWithNoActivityInNdays.Sat25 = _sat25;
			newVwBaseLeadGetWithNoActivityInNdays.Sat58 = _sat58;
			newVwBaseLeadGetWithNoActivityInNdays.Sun811 = _sun811;
			newVwBaseLeadGetWithNoActivityInNdays.Sun112 = _sun112;
			newVwBaseLeadGetWithNoActivityInNdays.Sun25 = _sun25;
			newVwBaseLeadGetWithNoActivityInNdays.Sun58 = _sun58;
			newVwBaseLeadGetWithNoActivityInNdays.LeadOwnerId = _leadOwnerId;
			newVwBaseLeadGetWithNoActivityInNdays.TotalCalls = _totalCalls;
			return newVwBaseLeadGetWithNoActivityInNdays;
		}
		...
		{
			get { return "vw_BaseLeadGetWithNoActivityInNDays"; }
		}
		...
		///<summary>
		///  Returns a Typed VwBaseLeadGetWithNoActivityInNdaysBase Entity 
		///</summary>
		public virtual VwBaseLeadGetWithNoActivityInNdaysBase Copy()
		{
			//shallow copy entity
			VwBaseLeadGetWithNoActivityInNdays copy = new VwBaseLeadGetWithNoActivityInNdays();
			...
			copy.AcceptChanges();
			return (VwBaseLeadGetWithNoActivityInNdays)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwBaseLeadGetWithNoActivityInNdaysBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwBaseLeadGetWithNoActivityInNdaysBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwBaseLeadGetWithNoActivityInNdaysBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwBaseLeadGetWithNoActivityInNdaysBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwBaseLeadGetWithNoActivityInNdaysBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwBaseLeadGetWithNoActivityInNdaysBase Object1, VwBaseLeadGetWithNoActivityInNdaysBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwBaseLeadGetWithNoActivityInNdays entity, string propertyName)
		{
			switch (propertyName)
			{
				case "CreatedBy":
		...
		{			
			return GetPropertyValueByName(this as VwBaseLeadGetWithNoActivityInNdays, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VwBaseLeadGetWithNoActivityInNdays columns.
	/// </summary>
	[Serializable]
	public enum VwBaseLeadGetWithNoActivityInNdaysColumn
	{
		/// <summary>
		/// Created By : 
		/// </summary>
