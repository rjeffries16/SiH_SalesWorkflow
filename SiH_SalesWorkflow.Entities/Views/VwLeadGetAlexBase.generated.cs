...
namespace SiH_SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwLeadGetAlexBase")]
	public abstract partial class VwLeadGetAlexBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwLeadGetAlexBase"/> instance.
		///</summary>
		public VwLeadGetAlexBase()
		{
		}		
		...
		{
			VwLeadGetAlex newVwLeadGetAlex = new VwLeadGetAlex();
			newVwLeadGetAlex.CreatedBy = _createdBy;
			newVwLeadGetAlex.CreatedTime = _createdTime;
			newVwLeadGetAlex.FirstName = _firstName;
			newVwLeadGetAlex.LastName = _lastName;
			newVwLeadGetAlex.IfNoLongerInterested = _ifNoLongerInterested;
			newVwLeadGetAlex.LastActivityTime = _lastActivityTime;
			newVwLeadGetAlex.LastVisitedTime = _lastVisitedTime;
			newVwLeadGetAlex.LeadOwner = _leadOwner;
			newVwLeadGetAlex.LeadSource = _leadSource;
			newVwLeadGetAlex.LeadStatus = _leadStatus;
			newVwLeadGetAlex.Leadid = _leadid;
			newVwLeadGetAlex.Rating = _rating;
			newVwLeadGetAlex.State = _state;
			newVwLeadGetAlex.TimeZone = _timeZone;
			newVwLeadGetAlex.LocalTime = _localTime;
			newVwLeadGetAlex.Url = _url;
			newVwLeadGetAlex.Website = _website;
			newVwLeadGetAlex.Worries = _worries;
			newVwLeadGetAlex.Leadpk = _leadpk;
			newVwLeadGetAlex.Wday811 = _wday811;
			newVwLeadGetAlex.Wday112 = _wday112;
			newVwLeadGetAlex.Wday25 = _wday25;
			newVwLeadGetAlex.Wday58 = _wday58;
			newVwLeadGetAlex.Sat811 = _sat811;
			newVwLeadGetAlex.Sat112 = _sat112;
			newVwLeadGetAlex.Sat25 = _sat25;
			newVwLeadGetAlex.Sat58 = _sat58;
			newVwLeadGetAlex.Sun811 = _sun811;
			newVwLeadGetAlex.Sun112 = _sun112;
			newVwLeadGetAlex.Sun25 = _sun25;
			newVwLeadGetAlex.Sun58 = _sun58;
			newVwLeadGetAlex.Priority = _priority;
			newVwLeadGetAlex.LeadOwnerId = _leadOwnerId;
			newVwLeadGetAlex.TotalCalls = _totalCalls;
			return newVwLeadGetAlex;
		}
		...
		///<summary>
		///  Returns a Typed VwLeadGetAlexBase Entity 
		///</summary>
		public virtual VwLeadGetAlexBase Copy()
		{
			//shallow copy entity
			VwLeadGetAlex copy = new VwLeadGetAlex();
		...
		///<returns>true if toObject is a <see cref="VwLeadGetAlexBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwLeadGetAlexBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwLeadGetAlexBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwLeadGetAlexBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwLeadGetAlexBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwLeadGetAlexBase Object1, VwLeadGetAlexBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwLeadGetAlex entity, string propertyName)
		{
			switch (propertyName)
			{
				case "CreatedBy":
		...
		{			
			return GetPropertyValueByName(this as VwLeadGetAlex, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VwLeadGetAlex columns.
	/// </summary>
	[Serializable]
	public enum VwLeadGetAlexColumn
	{
		/// <summary>
		/// Created By : 
		/// </summary>
