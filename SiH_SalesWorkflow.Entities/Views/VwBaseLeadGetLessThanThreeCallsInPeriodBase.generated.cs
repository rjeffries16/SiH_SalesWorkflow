...
namespace SiH_SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwBaseLeadGetLessThanThreeCallsInPeriodBase")]
	public abstract partial class VwBaseLeadGetLessThanThreeCallsInPeriodBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwBaseLeadGetLessThanThreeCallsInPeriodBase"/> instance.
		///</summary>
		public VwBaseLeadGetLessThanThreeCallsInPeriodBase()
		{
		}		
		...
		{
			VwBaseLeadGetLessThanThreeCallsInPeriod newVwBaseLeadGetLessThanThreeCallsInPeriod = new VwBaseLeadGetLessThanThreeCallsInPeriod();
			newVwBaseLeadGetLessThanThreeCallsInPeriod.CreatedBy = _createdBy;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.CreatedTime = _createdTime;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.FirstName = _firstName;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.LastName = _lastName;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.IfNoLongerInterested = _ifNoLongerInterested;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.LastActivityTime = _lastActivityTime;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.LastVisitedTime = _lastVisitedTime;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.LeadOwner = _leadOwner;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.LeadSource = _leadSource;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.LeadStatus = _leadStatus;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Leadid = _leadid;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Rating = _rating;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.State = _state;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.TimeZone = _timeZone;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.LocalTime = _localTime;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Url = _url;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Website = _website;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Worries = _worries;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Leadpk = _leadpk;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Wday811 = _wday811;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Wday112 = _wday112;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Wday25 = _wday25;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Wday58 = _wday58;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Sat811 = _sat811;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Sat112 = _sat112;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Sat25 = _sat25;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Sat58 = _sat58;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Sun811 = _sun811;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Sun112 = _sun112;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Sun25 = _sun25;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.Sun58 = _sun58;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.LeadOwnerId = _leadOwnerId;
			newVwBaseLeadGetLessThanThreeCallsInPeriod.TotalCalls = _totalCalls;
			return newVwBaseLeadGetLessThanThreeCallsInPeriod;
		}
		...
		{
			get { return "vw_BaseLeadGetLessThanThreeCallsInPeriod"; }
		}
		...
		///<summary>
		///  Returns a Typed VwBaseLeadGetLessThanThreeCallsInPeriodBase Entity 
		///</summary>
		public virtual VwBaseLeadGetLessThanThreeCallsInPeriodBase Copy()
		{
			//shallow copy entity
			VwBaseLeadGetLessThanThreeCallsInPeriod copy = new VwBaseLeadGetLessThanThreeCallsInPeriod();
			...
			copy.AcceptChanges();
			return (VwBaseLeadGetLessThanThreeCallsInPeriod)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwBaseLeadGetLessThanThreeCallsInPeriodBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwBaseLeadGetLessThanThreeCallsInPeriodBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwBaseLeadGetLessThanThreeCallsInPeriodBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwBaseLeadGetLessThanThreeCallsInPeriodBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwBaseLeadGetLessThanThreeCallsInPeriodBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwBaseLeadGetLessThanThreeCallsInPeriodBase Object1, VwBaseLeadGetLessThanThreeCallsInPeriodBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwBaseLeadGetLessThanThreeCallsInPeriod entity, string propertyName)
		{
			switch (propertyName)
			{
				case "CreatedBy":
		...
		{			
			return GetPropertyValueByName(this as VwBaseLeadGetLessThanThreeCallsInPeriod, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the VwBaseLeadGetLessThanThreeCallsInPeriod columns.
	/// </summary>
	[Serializable]
	public enum VwBaseLeadGetLessThanThreeCallsInPeriodColumn
	{
		/// <summary>
		/// Created By : 
		/// </summary>
