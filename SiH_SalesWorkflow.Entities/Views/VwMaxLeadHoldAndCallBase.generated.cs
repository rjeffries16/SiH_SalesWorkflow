...
namespace SiH_SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwMaxLeadHoldAndCallBase")]
	public abstract partial class VwMaxLeadHoldAndCallBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwMaxLeadHoldAndCallBase"/> instance.
		///</summary>
		public VwMaxLeadHoldAndCallBase()
		{
		}		
		...
		public VwMaxLeadHoldAndCallBase(System.String _leadid, System.DateTime? _leadHoldDts, System.DateTime? _leadActionDts)
		{
		...
		{
			VwMaxLeadHoldAndCall newVwMaxLeadHoldAndCall = new VwMaxLeadHoldAndCall();
			newVwMaxLeadHoldAndCall.Leadid = _leadid;
			newVwMaxLeadHoldAndCall.LeadHoldDts = _leadHoldDts;
			newVwMaxLeadHoldAndCall.LeadActionDts = _leadActionDts;
			return newVwMaxLeadHoldAndCall;
		}
		...
		{
			get { return "vw_MaxLeadHoldAndCall"; }
		}
		...
		///<summary>
		///  Returns a Typed VwMaxLeadHoldAndCallBase Entity 
		///</summary>
		public virtual VwMaxLeadHoldAndCallBase Copy()
		{
			//shallow copy entity
			VwMaxLeadHoldAndCall copy = new VwMaxLeadHoldAndCall();
				copy.Leadid = this.Leadid;
				copy.LeadHoldDts = this.LeadHoldDts;
				copy.LeadActionDts = this.LeadActionDts;
			copy.AcceptChanges();
			return (VwMaxLeadHoldAndCall)copy;
		}
		...
		///<returns>true if toObject is a <see cref="VwMaxLeadHoldAndCallBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwMaxLeadHoldAndCallBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwMaxLeadHoldAndCallBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwMaxLeadHoldAndCallBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwMaxLeadHoldAndCallBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwMaxLeadHoldAndCallBase Object1, VwMaxLeadHoldAndCallBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwMaxLeadHoldAndCall entity, string propertyName)
		{
			switch (propertyName)
			{
				case "Leadid":
		...
		{			
			return GetPropertyValueByName(this as VwMaxLeadHoldAndCall, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{4}{3}- Leadid: {0}{3}- LeadHoldDts: {1}{3}- LeadActionDts: {2}{3}", 
				this.Leadid,
	...
	/// <summary>
	/// Enumerate the VwMaxLeadHoldAndCall columns.
	/// </summary>
	[Serializable]
	public enum VwMaxLeadHoldAndCallColumn
	{
		/// <summary>
		/// LEADID : 
		/// </summary>
