...
namespace SiH_SalesWorkflow.Entities
{
	...
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VwLeadGetNextBase")]
	public abstract partial class VwLeadGetNextBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// Rank : 
		/// </summary>
		private System.Int32		  _rank = (int)0;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VwLeadGetNextBase"/> instance.
		///</summary>
		public VwLeadGetNextBase()
		{
		}		
		...
		{
			VwLeadGetNext newVwLeadGetNext = new VwLeadGetNext();
			newVwLeadGetNext.LeadStatus = _leadStatus;
			newVwLeadGetNext.Leadid = _leadid;
			newVwLeadGetNext.CreatedTime = _createdTime;
			newVwLeadGetNext.Email = _email;
			newVwLeadGetNext.FirstName = _firstName;
			newVwLeadGetNext.LastName = _lastName;
			newVwLeadGetNext.IfNoLongerInterested = _ifNoLongerInterested;
			newVwLeadGetNext.LastActivityTime = _lastActivityTime;
			newVwLeadGetNext.LastVisitedTime = _lastVisitedTime;
			newVwLeadGetNext.Rating = _rating;
			newVwLeadGetNext.State = _state;
			newVwLeadGetNext.TimeZone = _timeZone;
			newVwLeadGetNext.Phone = _phone;
			newVwLeadGetNext.Rank = _rank;
			newVwLeadGetNext.LeadOwner = _leadOwner;
			newVwLeadGetNext.UserId = _userId;
			newVwLeadGetNext.LeadHoldDts = _leadHoldDts;
			newVwLeadGetNext.LeadActionDts = _leadActionDts;
			return newVwLeadGetNext;
		}
		...
		///<summary>
		///  Returns a Typed VwLeadGetNextBase Entity 
		///</summary>
		public virtual VwLeadGetNextBase Copy()
		{
			//shallow copy entity
			VwLeadGetNext copy = new VwLeadGetNext();
		...
		///<returns>true if toObject is a <see cref="VwLeadGetNextBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VwLeadGetNextBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VwLeadGetNextBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VwLeadGetNextBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VwLeadGetNextBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VwLeadGetNextBase Object1, VwLeadGetNextBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VwLeadGetNext entity, string propertyName)
		{
			switch (propertyName)
			{
				case "LeadStatus":
		...
		{			
			return GetPropertyValueByName(this as VwLeadGetNext, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{19}{18}- LeadStatus: {0}{18}- Leadid: {1}{18}- CreatedTime: {2}{18}- Email: {3}{18}- FirstName: {4}{18}- LastName: {5}{18}- IfNoLongerInterested: {6}{18}- LastActivityTime: {7}{18}- LastVisitedTime: {8}{18}- Rating: {9}{18}- State: {10}{18}- TimeZone: {11}{18}- Phone: {12}{18}- Rank: {13}{18}- LeadOwner: {14}{18}- UserId: {15}{18}- LeadHoldDts: {16}{18}- LeadActionDts: {17}{18}", 
	...
	/// <summary>
	/// Enumerate the VwLeadGetNext columns.
	/// </summary>
	[Serializable]
	public enum VwLeadGetNextColumn
	{
		/// <summary>
		/// Lead Status : 
		/// </summary>
