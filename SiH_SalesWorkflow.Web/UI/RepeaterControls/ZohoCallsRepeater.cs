...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>ZohoCallsRepeater</c>
    /// </summary>
	public class ZohoCallsRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ZohoCallsRepeaterDesigner"/> class.
        /// </summary>
		public ZohoCallsRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is ZohoCallsRepeater))
			{ 
				throw new ArgumentException("Component is not a ZohoCallsRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			ZohoCallsRepeater z = (ZohoCallsRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="ZohoCallsRepeater"/> Type.
    /// </summary>
	[Designer(typeof(ZohoCallsRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:ZohoCallsRepeater runat=\"server\"></{0}:ZohoCallsRepeater>")]
	public class ZohoCallsRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:ZohoCallsRepeater"/> class.
        /// </summary>
		public ZohoCallsRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(ZohoCallsItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SiH_SalesWorkflow.Entities.ZohoCalls entity = o as SiH_SalesWorkflow.Entities.ZohoCalls;
						ZohoCallsItem container = new ZohoCallsItem(entity);
	...
	public class ZohoCallsItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private SiH_SalesWorkflow.Entities.ZohoCalls _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:ZohoCallsItem"/> class.
        /// </summary>
		public ZohoCallsItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:ZohoCallsItem"/> class.
        /// </summary>
		public ZohoCallsItem(SiH_SalesWorkflow.Entities.ZohoCalls entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:SiH_SalesWorkflow.Entities.ZohoCalls"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public SiH_SalesWorkflow.Entities.ZohoCalls Entity
        {
            get { return _entity; }
        }
	}
