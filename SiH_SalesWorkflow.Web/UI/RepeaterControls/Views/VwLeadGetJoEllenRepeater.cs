...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VwLeadGetJoEllenRepeater</c>
    /// </summary>
	public class VwLeadGetJoEllenRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetJoEllenRepeaterDesigner"/> class.
        /// </summary>
		public VwLeadGetJoEllenRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VwLeadGetJoEllenRepeater))
			{ 
				throw new ArgumentException("Component is not a VwLeadGetJoEllenRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VwLeadGetJoEllenRepeater z = (VwLeadGetJoEllenRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VwLeadGetJoEllenRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VwLeadGetJoEllenRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VwLeadGetJoEllenRepeater runat=\"server\"></{0}:VwLeadGetJoEllenRepeater>")]
	public class VwLeadGetJoEllenRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetJoEllenRepeater"/> class.
        /// </summary>
		public VwLeadGetJoEllenRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VwLeadGetJoEllenItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SiH_SalesWorkflow.Entities.VwLeadGetJoEllen entity = o as SiH_SalesWorkflow.Entities.VwLeadGetJoEllen;
						VwLeadGetJoEllenItem container = new VwLeadGetJoEllenItem(entity);
	...
	public class VwLeadGetJoEllenItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private SiH_SalesWorkflow.Entities.VwLeadGetJoEllen _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetJoEllenItem"/> class.
        /// </summary>
		public VwLeadGetJoEllenItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadGetJoEllenItem"/> class.
        /// </summary>
		public VwLeadGetJoEllenItem(SiH_SalesWorkflow.Entities.VwLeadGetJoEllen entity)
			: base()
		{
			_entity = entity;
		}
