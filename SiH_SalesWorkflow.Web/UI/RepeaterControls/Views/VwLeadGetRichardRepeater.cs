...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VwLeadGetRichardRepeater</c>
    /// </summary>
	public class VwLeadGetRichardRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetRichardRepeaterDesigner"/> class.
        /// </summary>
		public VwLeadGetRichardRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VwLeadGetRichardRepeater))
			{ 
				throw new ArgumentException("Component is not a VwLeadGetRichardRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VwLeadGetRichardRepeater z = (VwLeadGetRichardRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VwLeadGetRichardRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VwLeadGetRichardRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VwLeadGetRichardRepeater runat=\"server\"></{0}:VwLeadGetRichardRepeater>")]
	public class VwLeadGetRichardRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetRichardRepeater"/> class.
        /// </summary>
		public VwLeadGetRichardRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VwLeadGetRichardItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SiH_SalesWorkflow.Entities.VwLeadGetRichard entity = o as SiH_SalesWorkflow.Entities.VwLeadGetRichard;
						VwLeadGetRichardItem container = new VwLeadGetRichardItem(entity);
	...
	public class VwLeadGetRichardItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private SiH_SalesWorkflow.Entities.VwLeadGetRichard _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetRichardItem"/> class.
        /// </summary>
		public VwLeadGetRichardItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadGetRichardItem"/> class.
        /// </summary>
		public VwLeadGetRichardItem(SiH_SalesWorkflow.Entities.VwLeadGetRichard entity)
			: base()
		{
			_entity = entity;
		}
