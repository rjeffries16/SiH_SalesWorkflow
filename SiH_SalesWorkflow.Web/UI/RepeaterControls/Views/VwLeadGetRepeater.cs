...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VwLeadGetRepeater</c>
    /// </summary>
	public class VwLeadGetRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetRepeaterDesigner"/> class.
        /// </summary>
		public VwLeadGetRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VwLeadGetRepeater))
			{ 
				throw new ArgumentException("Component is not a VwLeadGetRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VwLeadGetRepeater z = (VwLeadGetRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VwLeadGetRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VwLeadGetRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VwLeadGetRepeater runat=\"server\"></{0}:VwLeadGetRepeater>")]
	public class VwLeadGetRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetRepeater"/> class.
        /// </summary>
		public VwLeadGetRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VwLeadGetItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SiH_SalesWorkflow.Entities.VwLeadGet entity = o as SiH_SalesWorkflow.Entities.VwLeadGet;
						VwLeadGetItem container = new VwLeadGetItem(entity);
	...
	public class VwLeadGetItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private SiH_SalesWorkflow.Entities.VwLeadGet _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetItem"/> class.
        /// </summary>
		public VwLeadGetItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadGetItem"/> class.
        /// </summary>
		public VwLeadGetItem(SiH_SalesWorkflow.Entities.VwLeadGet entity)
			: base()
		{
			_entity = entity;
		}
