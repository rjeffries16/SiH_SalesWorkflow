...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SiH_SalesWorkflow.Entities.VwLeadsAndCalls entity = o as SiH_SalesWorkflow.Entities.VwLeadsAndCalls;
	...
	{
		private SiH_SalesWorkflow.Entities.VwLeadsAndCalls _entity;
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadsAndCallsItem"/> class.
        /// </summary>
		public VwLeadsAndCallsItem(SiH_SalesWorkflow.Entities.VwLeadsAndCalls entity)
			: base()
		{
			_entity = entity;
		}
