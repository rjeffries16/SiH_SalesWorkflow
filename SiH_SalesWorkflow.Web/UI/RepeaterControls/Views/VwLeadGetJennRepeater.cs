...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>VwLeadGetJennRepeater</c>
    /// </summary>
	public class VwLeadGetJennRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetJennRepeaterDesigner"/> class.
        /// </summary>
		public VwLeadGetJennRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is VwLeadGetJennRepeater))
			{ 
				throw new ArgumentException("Component is not a VwLeadGetJennRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			VwLeadGetJennRepeater z = (VwLeadGetJennRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="VwLeadGetJennRepeater"/> Type.
    /// </summary>
	[Designer(typeof(VwLeadGetJennRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:VwLeadGetJennRepeater runat=\"server\"></{0}:VwLeadGetJennRepeater>")]
	public class VwLeadGetJennRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetJennRepeater"/> class.
        /// </summary>
		public VwLeadGetJennRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(VwLeadGetJennItem))]
...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SiH_SalesWorkflow.Entities.VwLeadGetJenn entity = o as SiH_SalesWorkflow.Entities.VwLeadGetJenn;
						VwLeadGetJennItem container = new VwLeadGetJennItem(entity);
	...
	public class VwLeadGetJennItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private SiH_SalesWorkflow.Entities.VwLeadGetJenn _entity;

        /// <summary>
        /// Initializes a new instance of the <see cref="T:VwLeadGetJennItem"/> class.
        /// </summary>
		public VwLeadGetJennItem()
			: base()
		{ }
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadGetJennItem"/> class.
        /// </summary>
		public VwLeadGetJennItem(SiH_SalesWorkflow.Entities.VwLeadGetJenn entity)
			: base()
		{
			_entity = entity;
		}
