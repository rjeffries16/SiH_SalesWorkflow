<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="JoEllenList.aspx.cs" Inherits="SiH_SalesWorkFlowWebApp.SalesLeads.JoEllenList" %>
...
<asp:Panel runat="server" Width="90%" >
    ...
    <br /><br />
     <span style="font-size: small">Time Zone Selection:<p>
        <asp:DropDownList ID="ddlTimeZone" runat="server">
        <asp:ListItem Text="PT" Value="P (+0)" Selected></asp:ListItem>
        <asp:ListItem Text="MT" Value="M (+1)"></asp:ListItem>
        <asp:ListItem Text="CT" Value="C (+2)"></asp:ListItem>
        <asp:ListItem Text="ET" Value="E (+3)"></asp:ListItem>
        </asp:DropDownList>
        </p>
     </span>
