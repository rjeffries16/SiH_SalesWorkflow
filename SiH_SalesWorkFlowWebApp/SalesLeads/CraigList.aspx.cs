...
{
    public partial class CraigList : System.Web.UI.Page
    {
        private String UserID = "1359242000002712055";// Craig
        ...
        protected void OpenWindow(object sender, EventArgs e)
        {
            ...
            if (lead.LeadId == null || lead.LeadId == "")
                lead = getLead.NextLead(UserID, ddlTimeZone.SelectedValue);
            else
            {
