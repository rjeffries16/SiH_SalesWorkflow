...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SalesWorkflow.Entities.VwLeadGetJoEllen entity = o as SalesWorkflow.Entities.VwLeadGetJoEllen;
	...
	{
		private SalesWorkflow.Entities.VwLeadGetJoEllen _entity;
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadGetJoEllenItem"/> class.
        /// </summary>
		public VwLeadGetJoEllenItem(SalesWorkflow.Entities.VwLeadGetJoEllen entity)
			: base()
		{
			_entity = entity;
		}
