...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SalesWorkflow.Entities.VwLeadHoldAndCall entity = o as SalesWorkflow.Entities.VwLeadHoldAndCall;
	...
	{
		private SalesWorkflow.Entities.VwLeadHoldAndCall _entity;
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadHoldAndCallItem"/> class.
        /// </summary>
		public VwLeadHoldAndCallItem(SalesWorkflow.Entities.VwLeadHoldAndCall entity)
			: base()
		{
			_entity = entity;
		}
