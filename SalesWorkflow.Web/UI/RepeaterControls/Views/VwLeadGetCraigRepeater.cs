...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SalesWorkflow.Entities.VwLeadGetCraig entity = o as SalesWorkflow.Entities.VwLeadGetCraig;
	...
	{
		private SalesWorkflow.Entities.VwLeadGetCraig _entity;
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadGetCraigItem"/> class.
        /// </summary>
		public VwLeadGetCraigItem(SalesWorkflow.Entities.VwLeadGetCraig entity)
			: base()
		{
			_entity = entity;
		}
