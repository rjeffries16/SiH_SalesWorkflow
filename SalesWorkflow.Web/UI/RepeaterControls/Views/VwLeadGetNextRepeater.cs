...
//		}
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
      {
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						SalesWorkflow.Entities.VwLeadGetNext entity = o as SalesWorkflow.Entities.VwLeadGetNext;
	...
	{
		private SalesWorkflow.Entities.VwLeadGetNext _entity;
        ...
        /// Initializes a new instance of the <see cref="T:VwLeadGetNextItem"/> class.
        /// </summary>
		public VwLeadGetNextItem(SalesWorkflow.Entities.VwLeadGetNext entity)
			: base()
		{
			_entity = entity;
		}
