...
{	
	...
	///</summary>
	public abstract partial class ZohoUsersProviderBaseCore : EntityProviderBase<SalesWorkflow.Entities.ZohoUsers, SalesWorkflow.Entities.ZohoUsersKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, SalesWorkflow.Entities.ZohoUsersKey key)
		{
		...
		public override SalesWorkflow.Entities.ZohoUsers Get(TransactionManager transactionManager, SalesWorkflow.Entities.ZohoUsersKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoUsers"/> class.</returns>
		public SalesWorkflow.Entities.ZohoUsers GetByUserpk(System.Int64 _userpk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoUsers"/> class.</returns>
		public SalesWorkflow.Entities.ZohoUsers GetByUserpk(System.Int64 _userpk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoUsers"/> class.</returns>
		public SalesWorkflow.Entities.ZohoUsers GetByUserpk(TransactionManager transactionManager, System.Int64 _userpk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoUsers"/> class.</returns>
		public SalesWorkflow.Entities.ZohoUsers GetByUserpk(TransactionManager transactionManager, System.Int64 _userpk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoUsers"/> class.</returns>
		public SalesWorkflow.Entities.ZohoUsers GetByUserpk(System.Int64 _userpk, int start, int pageLength, out int count)
		{
			return GetByUserpk(null, _userpk, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoUsers"/> class.</returns>
		public abstract SalesWorkflow.Entities.ZohoUsers GetByUserpk(TransactionManager transactionManager, System.Int64 _userpk, int start, int pageLength, out int count);
		...
		public static TList<ZohoUsers> Fill(IDataReader reader, TList<ZohoUsers> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				SalesWorkflow.Entities.ZohoUsers c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new SalesWorkflow.Entities.ZohoUsers();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="SalesWorkflow.Entities.ZohoUsers"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.ZohoUsers"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, SalesWorkflow.Entities.ZohoUsers entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="SalesWorkflow.Entities.ZohoUsers"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.ZohoUsers"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, SalesWorkflow.Entities.ZohoUsers entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.ZohoUsers"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">SalesWorkflow.Entities.ZohoUsers Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, SalesWorkflow.Entities.ZohoUsers entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the SalesWorkflow.Entities.ZohoUsers object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">SalesWorkflow.Entities.ZohoUsers instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">SalesWorkflow.Entities.ZohoUsers Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, SalesWorkflow.Entities.ZohoUsers entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>SalesWorkflow.Entities.ZohoUsers</c>
	///</summary>
