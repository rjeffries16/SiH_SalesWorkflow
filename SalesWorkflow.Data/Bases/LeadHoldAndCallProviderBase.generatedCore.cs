...
{	
	...
	///</summary>
	public abstract partial class LeadHoldAndCallProviderBaseCore : EntityProviderBase<SalesWorkflow.Entities.LeadHoldAndCall, SalesWorkflow.Entities.LeadHoldAndCallKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, SalesWorkflow.Entities.LeadHoldAndCallKey key)
		{
		...
		public override SalesWorkflow.Entities.LeadHoldAndCall Get(TransactionManager transactionManager, SalesWorkflow.Entities.LeadHoldAndCallKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> class.</returns>
		public SalesWorkflow.Entities.LeadHoldAndCall GetByLeadHoldAndCallPk(System.Int64 _leadHoldAndCallPk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> class.</returns>
		public SalesWorkflow.Entities.LeadHoldAndCall GetByLeadHoldAndCallPk(System.Int64 _leadHoldAndCallPk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> class.</returns>
		public SalesWorkflow.Entities.LeadHoldAndCall GetByLeadHoldAndCallPk(TransactionManager transactionManager, System.Int64 _leadHoldAndCallPk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> class.</returns>
		public SalesWorkflow.Entities.LeadHoldAndCall GetByLeadHoldAndCallPk(TransactionManager transactionManager, System.Int64 _leadHoldAndCallPk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> class.</returns>
		public SalesWorkflow.Entities.LeadHoldAndCall GetByLeadHoldAndCallPk(System.Int64 _leadHoldAndCallPk, int start, int pageLength, out int count)
		{
			return GetByLeadHoldAndCallPk(null, _leadHoldAndCallPk, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> class.</returns>
		public abstract SalesWorkflow.Entities.LeadHoldAndCall GetByLeadHoldAndCallPk(TransactionManager transactionManager, System.Int64 _leadHoldAndCallPk, int start, int pageLength, out int count);
		...
		public static TList<LeadHoldAndCall> Fill(IDataReader reader, TList<LeadHoldAndCall> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				SalesWorkflow.Entities.LeadHoldAndCall c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new SalesWorkflow.Entities.LeadHoldAndCall();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, SalesWorkflow.Entities.LeadHoldAndCall entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, SalesWorkflow.Entities.LeadHoldAndCall entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.LeadHoldAndCall"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">SalesWorkflow.Entities.LeadHoldAndCall Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, SalesWorkflow.Entities.LeadHoldAndCall entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the SalesWorkflow.Entities.LeadHoldAndCall object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">SalesWorkflow.Entities.LeadHoldAndCall instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">SalesWorkflow.Entities.LeadHoldAndCall Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, SalesWorkflow.Entities.LeadHoldAndCall entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>SalesWorkflow.Entities.LeadHoldAndCall</c>
	///</summary>
