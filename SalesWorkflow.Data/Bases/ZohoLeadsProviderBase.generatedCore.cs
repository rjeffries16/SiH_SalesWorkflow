...
{	
	...
	///</summary>
	public abstract partial class ZohoLeadsProviderBaseCore : EntityProviderBase<SalesWorkflow.Entities.ZohoLeads, SalesWorkflow.Entities.ZohoLeadsKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, SalesWorkflow.Entities.ZohoLeadsKey key)
		{
		...
		public override SalesWorkflow.Entities.ZohoLeads Get(TransactionManager transactionManager, SalesWorkflow.Entities.ZohoLeadsKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoLeads"/> class.</returns>
		public SalesWorkflow.Entities.ZohoLeads GetByLeadpk(System.Int64 _leadpk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoLeads"/> class.</returns>
		public SalesWorkflow.Entities.ZohoLeads GetByLeadpk(System.Int64 _leadpk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoLeads"/> class.</returns>
		public SalesWorkflow.Entities.ZohoLeads GetByLeadpk(TransactionManager transactionManager, System.Int64 _leadpk)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoLeads"/> class.</returns>
		public SalesWorkflow.Entities.ZohoLeads GetByLeadpk(TransactionManager transactionManager, System.Int64 _leadpk, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoLeads"/> class.</returns>
		public SalesWorkflow.Entities.ZohoLeads GetByLeadpk(System.Int64 _leadpk, int start, int pageLength, out int count)
		{
			return GetByLeadpk(null, _leadpk, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="SalesWorkflow.Entities.ZohoLeads"/> class.</returns>
		public abstract SalesWorkflow.Entities.ZohoLeads GetByLeadpk(TransactionManager transactionManager, System.Int64 _leadpk, int start, int pageLength, out int count);
		...
		public static TList<ZohoLeads> Fill(IDataReader reader, TList<ZohoLeads> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				SalesWorkflow.Entities.ZohoLeads c = null;
				if (useEntityFactory)
				{
				...
				{
					c = new SalesWorkflow.Entities.ZohoLeads();
				}
		...
		/// <summary>
		/// Refreshes the <see cref="SalesWorkflow.Entities.ZohoLeads"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.ZohoLeads"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, SalesWorkflow.Entities.ZohoLeads entity)
		{
		...
		/// <summary>
		/// Refreshes the <see cref="SalesWorkflow.Entities.ZohoLeads"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.ZohoLeads"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, SalesWorkflow.Entities.ZohoLeads entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="SalesWorkflow.Entities.ZohoLeads"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">SalesWorkflow.Entities.ZohoLeads Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, SalesWorkflow.Entities.ZohoLeads entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
		...
		/// <summary>
		/// Deep Save the entire object graph of the SalesWorkflow.Entities.ZohoLeads object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">SalesWorkflow.Entities.ZohoLeads instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">SalesWorkflow.Entities.ZohoLeads Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, SalesWorkflow.Entities.ZohoLeads entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>SalesWorkflow.Entities.ZohoLeads</c>
	///</summary>
