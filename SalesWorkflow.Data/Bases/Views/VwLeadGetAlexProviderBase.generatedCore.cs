...
{	
	///<summary>
	/// This class is the base class for any <see cref="VwLeadGetAlexProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class VwLeadGetAlexProviderBaseCore : EntityViewProviderBase<VwLeadGetAlex>
	{
		...
		/*
		///<summary>
		/// Fill an VList&lt;VwLeadGetAlex&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;VwLeadGetAlex&gt;"/></returns>
		protected static VList&lt;VwLeadGetAlex&gt; Fill(DataSet dataSet, VList<VwLeadGetAlex> rows, int start, int pagelen)
		{
			...
			{
				return new VList<VwLeadGetAlex>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;VwLeadGetAlex&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<VwLeadGetAlex>"/></returns>
		protected static VList&lt;VwLeadGetAlex&gt; Fill(DataTable dataTable, VList<VwLeadGetAlex> rows, int start, int pagelen)
		{
			int recordnum = 0;
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					VwLeadGetAlex c = new VwLeadGetAlex();
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;VwLeadGetAlex&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;VwLeadGetAlex&gt;"/></returns>
		protected VList<VwLeadGetAlex> Fill(IDataReader reader, VList<VwLeadGetAlex> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					VwLeadGetAlex entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<VwLeadGetAlex>("VwLeadGetAlex",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new VwLeadGetAlex();
					}
					
					entity.SuppressEntityEvents = true;

					entity.CreatedBy = (reader.IsDBNull(((int)VwLeadGetAlexColumn.CreatedBy)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.CreatedBy)];
					//entity.CreatedBy = (Convert.IsDBNull(reader["Created By"]))?string.Empty:(System.String)reader["Created By"];
					entity.CreatedTime = (reader.IsDBNull(((int)VwLeadGetAlexColumn.CreatedTime)))?null:(System.DateTime?)reader[((int)VwLeadGetAlexColumn.CreatedTime)];
					//entity.CreatedTime = (Convert.IsDBNull(reader["Created Time"]))?DateTime.MinValue:(System.DateTime?)reader["Created Time"];
					entity.FirstName = (reader.IsDBNull(((int)VwLeadGetAlexColumn.FirstName)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.FirstName)];
					//entity.FirstName = (Convert.IsDBNull(reader["First Name"]))?string.Empty:(System.String)reader["First Name"];
					entity.LastName = (reader.IsDBNull(((int)VwLeadGetAlexColumn.LastName)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.LastName)];
					//entity.LastName = (Convert.IsDBNull(reader["Last Name"]))?string.Empty:(System.String)reader["Last Name"];
					entity.IfNoLongerInterested = (reader.IsDBNull(((int)VwLeadGetAlexColumn.IfNoLongerInterested)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.IfNoLongerInterested)];
					...
					entity.LastActivityTime = (reader.IsDBNull(((int)VwLeadGetAlexColumn.LastActivityTime)))?null:(System.DateTime?)reader[((int)VwLeadGetAlexColumn.LastActivityTime)];
					...
					entity.LastVisitedTime = (reader.IsDBNull(((int)VwLeadGetAlexColumn.LastVisitedTime)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.LastVisitedTime)];
					//entity.LastVisitedTime = (Convert.IsDBNull(reader["Last Visited Time"]))?string.Empty:(System.String)reader["Last Visited Time"];
					entity.LeadOwner = (reader.IsDBNull(((int)VwLeadGetAlexColumn.LeadOwner)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.LeadOwner)];
					//entity.LeadOwner = (Convert.IsDBNull(reader["Lead Owner"]))?string.Empty:(System.String)reader["Lead Owner"];
					entity.LeadSource = (reader.IsDBNull(((int)VwLeadGetAlexColumn.LeadSource)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.LeadSource)];
					//entity.LeadSource = (Convert.IsDBNull(reader["Lead Source"]))?string.Empty:(System.String)reader["Lead Source"];
					entity.LeadStatus = (reader.IsDBNull(((int)VwLeadGetAlexColumn.LeadStatus)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.LeadStatus)];
					//entity.LeadStatus = (Convert.IsDBNull(reader["Lead Status"]))?string.Empty:(System.String)reader["Lead Status"];
					entity.Leadid = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Leadid)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.Leadid)];
					//entity.Leadid = (Convert.IsDBNull(reader["LEADID"]))?string.Empty:(System.String)reader["LEADID"];
					entity.Rating = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Rating)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.Rating)];
					//entity.Rating = (Convert.IsDBNull(reader["Rating"]))?string.Empty:(System.String)reader["Rating"];
					entity.State = (reader.IsDBNull(((int)VwLeadGetAlexColumn.State)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.State)];
					//entity.State = (Convert.IsDBNull(reader["State"]))?string.Empty:(System.String)reader["State"];
					entity.TimeZone = (reader.IsDBNull(((int)VwLeadGetAlexColumn.TimeZone)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.TimeZone)];
					//entity.TimeZone = (Convert.IsDBNull(reader["Time Zone"]))?string.Empty:(System.String)reader["Time Zone"];
					entity.LocalTime = (reader.IsDBNull(((int)VwLeadGetAlexColumn.LocalTime)))?null:(System.DateTime?)reader[((int)VwLeadGetAlexColumn.LocalTime)];
					//entity.LocalTime = (Convert.IsDBNull(reader["LocalTime"]))?DateTime.MinValue:(System.DateTime?)reader["LocalTime"];
					entity.Url = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Url)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.Url)];
					//entity.Url = (Convert.IsDBNull(reader["URL"]))?string.Empty:(System.String)reader["URL"];
					entity.Website = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Website)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.Website)];
					//entity.Website = (Convert.IsDBNull(reader["Website"]))?string.Empty:(System.String)reader["Website"];
					entity.Worries = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Worries)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.Worries)];
					//entity.Worries = (Convert.IsDBNull(reader["Worries"]))?string.Empty:(System.String)reader["Worries"];
					entity.Leadpk = (System.Int64)reader[((int)VwLeadGetAlexColumn.Leadpk)];
					//entity.Leadpk = (Convert.IsDBNull(reader["LEADPK"]))?(long)0:(System.Int64)reader["LEADPK"];
					entity.Wday811 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Wday811)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Wday811)];
					//entity.Wday811 = (Convert.IsDBNull(reader["WDay8-11"]))?(int)0:(System.Int32?)reader["WDay8-11"];
					entity.Wday112 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Wday112)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Wday112)];
					//entity.Wday112 = (Convert.IsDBNull(reader["WDay11-2"]))?(int)0:(System.Int32?)reader["WDay11-2"];
					entity.Wday25 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Wday25)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Wday25)];
					//entity.Wday25 = (Convert.IsDBNull(reader["WDay2-5"]))?(int)0:(System.Int32?)reader["WDay2-5"];
					entity.Wday58 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Wday58)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Wday58)];
					//entity.Wday58 = (Convert.IsDBNull(reader["WDay5-8"]))?(int)0:(System.Int32?)reader["WDay5-8"];
					entity.Sat811 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Sat811)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Sat811)];
					//entity.Sat811 = (Convert.IsDBNull(reader["Sat8-11"]))?(int)0:(System.Int32?)reader["Sat8-11"];
					entity.Sat112 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Sat112)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Sat112)];
					//entity.Sat112 = (Convert.IsDBNull(reader["Sat11-2"]))?(int)0:(System.Int32?)reader["Sat11-2"];
					entity.Sat25 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Sat25)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Sat25)];
					//entity.Sat25 = (Convert.IsDBNull(reader["Sat2-5"]))?(int)0:(System.Int32?)reader["Sat2-5"];
					entity.Sat58 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Sat58)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Sat58)];
					//entity.Sat58 = (Convert.IsDBNull(reader["Sat5-8"]))?(int)0:(System.Int32?)reader["Sat5-8"];
					entity.Sun811 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Sun811)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Sun811)];
					//entity.Sun811 = (Convert.IsDBNull(reader["Sun8-11"]))?(int)0:(System.Int32?)reader["Sun8-11"];
					entity.Sun112 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Sun112)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Sun112)];
					//entity.Sun112 = (Convert.IsDBNull(reader["Sun11-2"]))?(int)0:(System.Int32?)reader["Sun11-2"];
					entity.Sun25 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Sun25)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Sun25)];
					//entity.Sun25 = (Convert.IsDBNull(reader["Sun2-5"]))?(int)0:(System.Int32?)reader["Sun2-5"];
					entity.Sun58 = (reader.IsDBNull(((int)VwLeadGetAlexColumn.Sun58)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.Sun58)];
					//entity.Sun58 = (Convert.IsDBNull(reader["Sun5-8"]))?(int)0:(System.Int32?)reader["Sun5-8"];
					entity.Priority = (System.Int32)reader[((int)VwLeadGetAlexColumn.Priority)];
					//entity.Priority = (Convert.IsDBNull(reader["Priority"]))?(int)0:(System.Int32)reader["Priority"];
					entity.LeadOwnerId = (reader.IsDBNull(((int)VwLeadGetAlexColumn.LeadOwnerId)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.LeadOwnerId)];
					//entity.LeadOwnerId = (Convert.IsDBNull(reader["Lead Owner Id"]))?string.Empty:(System.String)reader["Lead Owner Id"];
					entity.TotalCalls = (reader.IsDBNull(((int)VwLeadGetAlexColumn.TotalCalls)))?null:(System.Int32?)reader[((int)VwLeadGetAlexColumn.TotalCalls)];
		...
		/// <summary>
		/// Refreshes the <see cref="VwLeadGetAlex"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="VwLeadGetAlex"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, VwLeadGetAlex entity)
		{
			reader.Read();
			entity.CreatedBy = (reader.IsDBNull(((int)VwLeadGetAlexColumn.CreatedBy)))?null:(System.String)reader[((int)VwLeadGetAlexColumn.CreatedBy)];
			//entity.CreatedBy = (Convert.IsDBNull(reader["Created By"]))?string.Empty:(System.String)reader["Created By"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="VwLeadGetAlex"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="VwLeadGetAlex"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, VwLeadGetAlex entity)
		{
	...
	#region VwLeadGetAlexFilterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class VwLeadGetAlexFilterBuilder : SqlFilterBuilder<VwLeadGetAlexColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetAlexFilterBuilder class.
		/// </summary>
		public VwLeadGetAlexFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the VwLeadGetAlexFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public VwLeadGetAlexFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public VwLeadGetAlexFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion VwLeadGetAlexFilterBuilder

	#region VwLeadGetAlexParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class VwLeadGetAlexParameterBuilder : ParameterizedSqlFilterBuilder<VwLeadGetAlexColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetAlexParameterBuilder class.
		/// </summary>
		public VwLeadGetAlexParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the VwLeadGetAlexParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public VwLeadGetAlexParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public VwLeadGetAlexParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion VwLeadGetAlexParameterBuilder
	
	#region VwLeadGetAlexSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class VwLeadGetAlexSortBuilder : SqlSortBuilder<VwLeadGetAlexColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetAlexSqlSortBuilder class.
		/// </summary>
		public VwLeadGetAlexSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion VwLeadGetAlexSortBuilder
