...
{	
	///<summary>
	/// This class is the base class for any <see cref="VwLeadGetProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class VwLeadGetProviderBaseCore : EntityViewProviderBase<VwLeadGet>
	{
		...
		/*
		///<summary>
		/// Fill an VList&lt;VwLeadGet&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;VwLeadGet&gt;"/></returns>
		protected static VList&lt;VwLeadGet&gt; Fill(DataSet dataSet, VList<VwLeadGet> rows, int start, int pagelen)
		{
			...
			{
				return new VList<VwLeadGet>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;VwLeadGet&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<VwLeadGet>"/></returns>
		protected static VList&lt;VwLeadGet&gt; Fill(DataTable dataTable, VList<VwLeadGet> rows, int start, int pagelen)
		{
			int recordnum = 0;
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;VwLeadGet&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;VwLeadGet&gt;"/></returns>
		protected VList<VwLeadGet> Fill(IDataReader reader, VList<VwLeadGet> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					VwLeadGet entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<VwLeadGet>("VwLeadGet",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new VwLeadGet();
					}
					
					entity.SuppressEntityEvents = true;

					entity.CreatedBy = (reader.IsDBNull(((int)VwLeadGetColumn.CreatedBy)))?null:(System.String)reader[((int)VwLeadGetColumn.CreatedBy)];
					//entity.CreatedBy = (Convert.IsDBNull(reader["Created By"]))?string.Empty:(System.String)reader["Created By"];
					entity.CreatedTime = (reader.IsDBNull(((int)VwLeadGetColumn.CreatedTime)))?null:(System.DateTime?)reader[((int)VwLeadGetColumn.CreatedTime)];
					//entity.CreatedTime = (Convert.IsDBNull(reader["Created Time"]))?DateTime.MinValue:(System.DateTime?)reader["Created Time"];
					entity.FirstName = (reader.IsDBNull(((int)VwLeadGetColumn.FirstName)))?null:(System.String)reader[((int)VwLeadGetColumn.FirstName)];
					//entity.FirstName = (Convert.IsDBNull(reader["First Name"]))?string.Empty:(System.String)reader["First Name"];
					entity.LastName = (reader.IsDBNull(((int)VwLeadGetColumn.LastName)))?null:(System.String)reader[((int)VwLeadGetColumn.LastName)];
					//entity.LastName = (Convert.IsDBNull(reader["Last Name"]))?string.Empty:(System.String)reader["Last Name"];
					entity.IfNoLongerInterested = (reader.IsDBNull(((int)VwLeadGetColumn.IfNoLongerInterested)))?null:(System.String)reader[((int)VwLeadGetColumn.IfNoLongerInterested)];
					...
					entity.LastActivityTime = (reader.IsDBNull(((int)VwLeadGetColumn.LastActivityTime)))?null:(System.DateTime?)reader[((int)VwLeadGetColumn.LastActivityTime)];
					...
					entity.LastVisitedTime = (reader.IsDBNull(((int)VwLeadGetColumn.LastVisitedTime)))?null:(System.String)reader[((int)VwLeadGetColumn.LastVisitedTime)];
					//entity.LastVisitedTime = (Convert.IsDBNull(reader["Last Visited Time"]))?string.Empty:(System.String)reader["Last Visited Time"];
					entity.LeadOwner = (reader.IsDBNull(((int)VwLeadGetColumn.LeadOwner)))?null:(System.String)reader[((int)VwLeadGetColumn.LeadOwner)];
					//entity.LeadOwner = (Convert.IsDBNull(reader["Lead Owner"]))?string.Empty:(System.String)reader["Lead Owner"];
					entity.LeadSource = (reader.IsDBNull(((int)VwLeadGetColumn.LeadSource)))?null:(System.String)reader[((int)VwLeadGetColumn.LeadSource)];
					//entity.LeadSource = (Convert.IsDBNull(reader["Lead Source"]))?string.Empty:(System.String)reader["Lead Source"];
					entity.LeadStatus = (reader.IsDBNull(((int)VwLeadGetColumn.LeadStatus)))?null:(System.String)reader[((int)VwLeadGetColumn.LeadStatus)];
					//entity.LeadStatus = (Convert.IsDBNull(reader["Lead Status"]))?string.Empty:(System.String)reader["Lead Status"];
					entity.Leadid = (reader.IsDBNull(((int)VwLeadGetColumn.Leadid)))?null:(System.String)reader[((int)VwLeadGetColumn.Leadid)];
					//entity.Leadid = (Convert.IsDBNull(reader["LEADID"]))?string.Empty:(System.String)reader["LEADID"];
					entity.Rating = (reader.IsDBNull(((int)VwLeadGetColumn.Rating)))?null:(System.String)reader[((int)VwLeadGetColumn.Rating)];
					//entity.Rating = (Convert.IsDBNull(reader["Rating"]))?string.Empty:(System.String)reader["Rating"];
					entity.State = (reader.IsDBNull(((int)VwLeadGetColumn.State)))?null:(System.String)reader[((int)VwLeadGetColumn.State)];
					//entity.State = (Convert.IsDBNull(reader["State"]))?string.Empty:(System.String)reader["State"];
					entity.TimeZone = (reader.IsDBNull(((int)VwLeadGetColumn.TimeZone)))?null:(System.String)reader[((int)VwLeadGetColumn.TimeZone)];
					//entity.TimeZone = (Convert.IsDBNull(reader["Time Zone"]))?string.Empty:(System.String)reader["Time Zone"];
					entity.LocalTime = (reader.IsDBNull(((int)VwLeadGetColumn.LocalTime)))?null:(System.DateTime?)reader[((int)VwLeadGetColumn.LocalTime)];
					//entity.LocalTime = (Convert.IsDBNull(reader["LocalTime"]))?DateTime.MinValue:(System.DateTime?)reader["LocalTime"];
					entity.Url = (reader.IsDBNull(((int)VwLeadGetColumn.Url)))?null:(System.String)reader[((int)VwLeadGetColumn.Url)];
					//entity.Url = (Convert.IsDBNull(reader["URL"]))?string.Empty:(System.String)reader["URL"];
					entity.Website = (reader.IsDBNull(((int)VwLeadGetColumn.Website)))?null:(System.String)reader[((int)VwLeadGetColumn.Website)];
					//entity.Website = (Convert.IsDBNull(reader["Website"]))?string.Empty:(System.String)reader["Website"];
					entity.Worries = (reader.IsDBNull(((int)VwLeadGetColumn.Worries)))?null:(System.String)reader[((int)VwLeadGetColumn.Worries)];
					//entity.Worries = (Convert.IsDBNull(reader["Worries"]))?string.Empty:(System.String)reader["Worries"];
					entity.Leadpk = (System.Int64)reader[((int)VwLeadGetColumn.Leadpk)];
					//entity.Leadpk = (Convert.IsDBNull(reader["LEADPK"]))?(long)0:(System.Int64)reader["LEADPK"];
					entity.Wday811 = (reader.IsDBNull(((int)VwLeadGetColumn.Wday811)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Wday811)];
					//entity.Wday811 = (Convert.IsDBNull(reader["WDay8-11"]))?(int)0:(System.Int32?)reader["WDay8-11"];
					entity.Wday112 = (reader.IsDBNull(((int)VwLeadGetColumn.Wday112)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Wday112)];
					//entity.Wday112 = (Convert.IsDBNull(reader["WDay11-2"]))?(int)0:(System.Int32?)reader["WDay11-2"];
					entity.Wday25 = (reader.IsDBNull(((int)VwLeadGetColumn.Wday25)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Wday25)];
					//entity.Wday25 = (Convert.IsDBNull(reader["WDay2-5"]))?(int)0:(System.Int32?)reader["WDay2-5"];
					entity.Wday58 = (reader.IsDBNull(((int)VwLeadGetColumn.Wday58)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Wday58)];
					//entity.Wday58 = (Convert.IsDBNull(reader["WDay5-8"]))?(int)0:(System.Int32?)reader["WDay5-8"];
					entity.Sat811 = (reader.IsDBNull(((int)VwLeadGetColumn.Sat811)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Sat811)];
					//entity.Sat811 = (Convert.IsDBNull(reader["Sat8-11"]))?(int)0:(System.Int32?)reader["Sat8-11"];
					entity.Sat112 = (reader.IsDBNull(((int)VwLeadGetColumn.Sat112)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Sat112)];
					//entity.Sat112 = (Convert.IsDBNull(reader["Sat11-2"]))?(int)0:(System.Int32?)reader["Sat11-2"];
					entity.Sat25 = (reader.IsDBNull(((int)VwLeadGetColumn.Sat25)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Sat25)];
					//entity.Sat25 = (Convert.IsDBNull(reader["Sat2-5"]))?(int)0:(System.Int32?)reader["Sat2-5"];
					entity.Sat58 = (reader.IsDBNull(((int)VwLeadGetColumn.Sat58)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Sat58)];
					//entity.Sat58 = (Convert.IsDBNull(reader["Sat5-8"]))?(int)0:(System.Int32?)reader["Sat5-8"];
					entity.Sun811 = (reader.IsDBNull(((int)VwLeadGetColumn.Sun811)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Sun811)];
					//entity.Sun811 = (Convert.IsDBNull(reader["Sun8-11"]))?(int)0:(System.Int32?)reader["Sun8-11"];
					entity.Sun112 = (reader.IsDBNull(((int)VwLeadGetColumn.Sun112)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Sun112)];
					//entity.Sun112 = (Convert.IsDBNull(reader["Sun11-2"]))?(int)0:(System.Int32?)reader["Sun11-2"];
					entity.Sun25 = (reader.IsDBNull(((int)VwLeadGetColumn.Sun25)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Sun25)];
					//entity.Sun25 = (Convert.IsDBNull(reader["Sun2-5"]))?(int)0:(System.Int32?)reader["Sun2-5"];
					entity.Sun58 = (reader.IsDBNull(((int)VwLeadGetColumn.Sun58)))?null:(System.Int32?)reader[((int)VwLeadGetColumn.Sun58)];
					//entity.Sun58 = (Convert.IsDBNull(reader["Sun5-8"]))?(int)0:(System.Int32?)reader["Sun5-8"];
					entity.LeadOwnerId = (reader.IsDBNull(((int)VwLeadGetColumn.LeadOwnerId)))?null:(System.String)reader[((int)VwLeadGetColumn.LeadOwnerId)];
		...
		/// <summary>
		/// Refreshes the <see cref="VwLeadGet"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="VwLeadGet"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, VwLeadGet entity)
		{
			reader.Read();
			entity.CreatedBy = (reader.IsDBNull(((int)VwLeadGetColumn.CreatedBy)))?null:(System.String)reader[((int)VwLeadGetColumn.CreatedBy)];
			//entity.CreatedBy = (Convert.IsDBNull(reader["Created By"]))?string.Empty:(System.String)reader["Created By"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="VwLeadGet"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="VwLeadGet"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, VwLeadGet entity)
		{
	...
	/// </summary>
	[CLSCompliant(true)]
	public class VwLeadGetFilterBuilder : SqlFilterBuilder<VwLeadGetColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetFilterBuilder class.
		/// </summary>
		public VwLeadGetFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the VwLeadGetFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public VwLeadGetFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public VwLeadGetFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion VwLeadGetFilterBuilder

	#region VwLeadGetParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class VwLeadGetParameterBuilder : ParameterizedSqlFilterBuilder<VwLeadGetColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetParameterBuilder class.
		/// </summary>
		public VwLeadGetParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the VwLeadGetParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public VwLeadGetParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public VwLeadGetParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion VwLeadGetParameterBuilder
	
	#region VwLeadGetSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class VwLeadGetSortBuilder : SqlSortBuilder<VwLeadGetColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetSqlSortBuilder class.
		/// </summary>
		public VwLeadGetSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion VwLeadGetSortBuilder
