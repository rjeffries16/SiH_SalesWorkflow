...
{	
	///<summary>
	/// This class is the base class for any <see cref="VwLeadGetJoEllenProviderBase"/> implementation.
	/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
	///</summary>
	public abstract class VwLeadGetJoEllenProviderBaseCore : EntityViewProviderBase<VwLeadGetJoEllen>
	{
		...
		/*
		///<summary>
		/// Fill an VList&lt;VwLeadGetJoEllen&gt; From a DataSet
		///</summary>
		/// <param name="dataSet">the DataSet</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList&lt;VwLeadGetJoEllen&gt;"/></returns>
		protected static VList&lt;VwLeadGetJoEllen&gt; Fill(DataSet dataSet, VList<VwLeadGetJoEllen> rows, int start, int pagelen)
		{
			...
			{
				return new VList<VwLeadGetJoEllen>();
			}	
		}
		
		
		///<summary>
		/// Fill an VList&lt;VwLeadGetJoEllen&gt; From a DataTable
		///</summary>
		...
		/// <param name="pagelen">number of row.</param>
		///<returns><see chref="VList<VwLeadGetJoEllen>"/></returns>
		protected static VList&lt;VwLeadGetJoEllen&gt; Fill(DataTable dataTable, VList<VwLeadGetJoEllen> rows, int start, int pagelen)
		{
			int recordnum = 0;
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					VwLeadGetJoEllen c = new VwLeadGetJoEllen();
		...
		*/	
		...
		///<summary>
		/// Fill an <see cref="VList&lt;VwLeadGetJoEllen&gt;"/> From a DataReader.
		///</summary>
		/// <param name="reader">Datareader</param>
		/// <param name="rows">The collection to fill</param>
		/// <param name="start">Start row</param>
		/// <param name="pageLength">number of row.</param>
		///<returns>a <see cref="VList&lt;VwLeadGetJoEllen&gt;"/></returns>
		protected VList<VwLeadGetJoEllen> Fill(IDataReader reader, VList<VwLeadGetJoEllen> rows, int start, int pageLength)
		{
			int recordnum = 0;
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					VwLeadGetJoEllen entity = null;
					if (DataRepository.Provider.UseEntityFactory)
					{
						entity = EntityManager.CreateViewEntity<VwLeadGetJoEllen>("VwLeadGetJoEllen",  DataRepository.Provider.EntityCreationalFactoryType); 
					}
					else
					{
						entity = new VwLeadGetJoEllen();
					}
					
					entity.SuppressEntityEvents = true;

					entity.CreatedBy = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.CreatedBy)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.CreatedBy)];
					//entity.CreatedBy = (Convert.IsDBNull(reader["Created By"]))?string.Empty:(System.String)reader["Created By"];
					entity.CreatedTime = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.CreatedTime)))?null:(System.DateTime?)reader[((int)VwLeadGetJoEllenColumn.CreatedTime)];
					//entity.CreatedTime = (Convert.IsDBNull(reader["Created Time"]))?DateTime.MinValue:(System.DateTime?)reader["Created Time"];
					entity.FirstName = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.FirstName)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.FirstName)];
					//entity.FirstName = (Convert.IsDBNull(reader["First Name"]))?string.Empty:(System.String)reader["First Name"];
					entity.LastName = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.LastName)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.LastName)];
					//entity.LastName = (Convert.IsDBNull(reader["Last Name"]))?string.Empty:(System.String)reader["Last Name"];
					entity.IfNoLongerInterested = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.IfNoLongerInterested)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.IfNoLongerInterested)];
					...
					entity.LastActivityTime = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.LastActivityTime)))?null:(System.DateTime?)reader[((int)VwLeadGetJoEllenColumn.LastActivityTime)];
					...
					entity.LastVisitedTime = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.LastVisitedTime)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.LastVisitedTime)];
					//entity.LastVisitedTime = (Convert.IsDBNull(reader["Last Visited Time"]))?string.Empty:(System.String)reader["Last Visited Time"];
					entity.LeadOwner = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.LeadOwner)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.LeadOwner)];
					//entity.LeadOwner = (Convert.IsDBNull(reader["Lead Owner"]))?string.Empty:(System.String)reader["Lead Owner"];
					entity.LeadSource = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.LeadSource)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.LeadSource)];
					//entity.LeadSource = (Convert.IsDBNull(reader["Lead Source"]))?string.Empty:(System.String)reader["Lead Source"];
					entity.LeadStatus = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.LeadStatus)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.LeadStatus)];
					//entity.LeadStatus = (Convert.IsDBNull(reader["Lead Status"]))?string.Empty:(System.String)reader["Lead Status"];
					entity.Leadid = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Leadid)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.Leadid)];
					//entity.Leadid = (Convert.IsDBNull(reader["LEADID"]))?string.Empty:(System.String)reader["LEADID"];
					entity.Rating = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Rating)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.Rating)];
					//entity.Rating = (Convert.IsDBNull(reader["Rating"]))?string.Empty:(System.String)reader["Rating"];
					entity.State = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.State)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.State)];
					//entity.State = (Convert.IsDBNull(reader["State"]))?string.Empty:(System.String)reader["State"];
					entity.TimeZone = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.TimeZone)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.TimeZone)];
					//entity.TimeZone = (Convert.IsDBNull(reader["Time Zone"]))?string.Empty:(System.String)reader["Time Zone"];
					entity.LocalTime = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.LocalTime)))?null:(System.DateTime?)reader[((int)VwLeadGetJoEllenColumn.LocalTime)];
					//entity.LocalTime = (Convert.IsDBNull(reader["LocalTime"]))?DateTime.MinValue:(System.DateTime?)reader["LocalTime"];
					entity.Url = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Url)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.Url)];
					//entity.Url = (Convert.IsDBNull(reader["URL"]))?string.Empty:(System.String)reader["URL"];
					entity.Website = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Website)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.Website)];
					//entity.Website = (Convert.IsDBNull(reader["Website"]))?string.Empty:(System.String)reader["Website"];
					entity.Worries = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Worries)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.Worries)];
					//entity.Worries = (Convert.IsDBNull(reader["Worries"]))?string.Empty:(System.String)reader["Worries"];
					entity.Leadpk = (System.Int64)reader[((int)VwLeadGetJoEllenColumn.Leadpk)];
					//entity.Leadpk = (Convert.IsDBNull(reader["LEADPK"]))?(long)0:(System.Int64)reader["LEADPK"];
					entity.Wday811 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Wday811)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Wday811)];
					//entity.Wday811 = (Convert.IsDBNull(reader["WDay8-11"]))?(int)0:(System.Int32?)reader["WDay8-11"];
					entity.Wday112 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Wday112)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Wday112)];
					//entity.Wday112 = (Convert.IsDBNull(reader["WDay11-2"]))?(int)0:(System.Int32?)reader["WDay11-2"];
					entity.Wday25 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Wday25)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Wday25)];
					//entity.Wday25 = (Convert.IsDBNull(reader["WDay2-5"]))?(int)0:(System.Int32?)reader["WDay2-5"];
					entity.Wday58 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Wday58)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Wday58)];
					//entity.Wday58 = (Convert.IsDBNull(reader["WDay5-8"]))?(int)0:(System.Int32?)reader["WDay5-8"];
					entity.Sat811 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Sat811)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Sat811)];
					//entity.Sat811 = (Convert.IsDBNull(reader["Sat8-11"]))?(int)0:(System.Int32?)reader["Sat8-11"];
					entity.Sat112 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Sat112)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Sat112)];
					//entity.Sat112 = (Convert.IsDBNull(reader["Sat11-2"]))?(int)0:(System.Int32?)reader["Sat11-2"];
					entity.Sat25 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Sat25)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Sat25)];
					//entity.Sat25 = (Convert.IsDBNull(reader["Sat2-5"]))?(int)0:(System.Int32?)reader["Sat2-5"];
					entity.Sat58 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Sat58)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Sat58)];
					//entity.Sat58 = (Convert.IsDBNull(reader["Sat5-8"]))?(int)0:(System.Int32?)reader["Sat5-8"];
					entity.Sun811 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Sun811)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Sun811)];
					//entity.Sun811 = (Convert.IsDBNull(reader["Sun8-11"]))?(int)0:(System.Int32?)reader["Sun8-11"];
					entity.Sun112 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Sun112)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Sun112)];
					//entity.Sun112 = (Convert.IsDBNull(reader["Sun11-2"]))?(int)0:(System.Int32?)reader["Sun11-2"];
					entity.Sun25 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Sun25)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Sun25)];
					//entity.Sun25 = (Convert.IsDBNull(reader["Sun2-5"]))?(int)0:(System.Int32?)reader["Sun2-5"];
					entity.Sun58 = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.Sun58)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.Sun58)];
					//entity.Sun58 = (Convert.IsDBNull(reader["Sun5-8"]))?(int)0:(System.Int32?)reader["Sun5-8"];
					entity.Priority = (System.Int32)reader[((int)VwLeadGetJoEllenColumn.Priority)];
					//entity.Priority = (Convert.IsDBNull(reader["Priority"]))?(int)0:(System.Int32)reader["Priority"];
					entity.LeadOwnerId = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.LeadOwnerId)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.LeadOwnerId)];
					//entity.LeadOwnerId = (Convert.IsDBNull(reader["Lead Owner Id"]))?string.Empty:(System.String)reader["Lead Owner Id"];
					entity.TotalCalls = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.TotalCalls)))?null:(System.Int32?)reader[((int)VwLeadGetJoEllenColumn.TotalCalls)];
		...
		/// <summary>
		/// Refreshes the <see cref="VwLeadGetJoEllen"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="VwLeadGetJoEllen"/> object to refresh.</param>
		protected void RefreshEntity(IDataReader reader, VwLeadGetJoEllen entity)
		{
			reader.Read();
			entity.CreatedBy = (reader.IsDBNull(((int)VwLeadGetJoEllenColumn.CreatedBy)))?null:(System.String)reader[((int)VwLeadGetJoEllenColumn.CreatedBy)];
			//entity.CreatedBy = (Convert.IsDBNull(reader["Created By"]))?string.Empty:(System.String)reader["Created By"];
		...
		/*
		/// <summary>
		/// Refreshes the <see cref="VwLeadGetJoEllen"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="VwLeadGetJoEllen"/> object.</param>
		protected static void RefreshEntity(DataSet dataSet, VwLeadGetJoEllen entity)
		{
	...
	#region VwLeadGetJoEllenFilterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class VwLeadGetJoEllenFilterBuilder : SqlFilterBuilder<VwLeadGetJoEllenColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetJoEllenFilterBuilder class.
		/// </summary>
		public VwLeadGetJoEllenFilterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the VwLeadGetJoEllenFilterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public VwLeadGetJoEllenFilterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		public VwLeadGetJoEllenFilterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion VwLeadGetJoEllenFilterBuilder

	#region VwLeadGetJoEllenParameterBuilder
	...
	/// </summary>
	[CLSCompliant(true)]
	public class VwLeadGetJoEllenParameterBuilder : ParameterizedSqlFilterBuilder<VwLeadGetJoEllenColumn>
	{
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetJoEllenParameterBuilder class.
		/// </summary>
		public VwLeadGetJoEllenParameterBuilder() : base() { }

		/// <summary>
		/// Initializes a new instance of the VwLeadGetJoEllenParameterBuilder class.
		/// </summary>
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		public VwLeadGetJoEllenParameterBuilder(bool ignoreCase) : base(ignoreCase) { }
		...
		/// <param name="ignoreCase">Specifies whether to create case-insensitive statements.</param>
		/// <param name="useAnd">Specifies whether to combine statements using AND or OR.</param>
		public VwLeadGetJoEllenParameterBuilder(bool ignoreCase, bool useAnd) : base(ignoreCase, useAnd) { }

		#endregion Constructors
	}

	#endregion VwLeadGetJoEllenParameterBuilder
	
	#region VwLeadGetJoEllenSortBuilder
    ...
    /// </summary>
    [CLSCompliant(true)]
    public class VwLeadGetJoEllenSortBuilder : SqlSortBuilder<VwLeadGetJoEllenColumn>
    {
		#region Constructors

		/// <summary>
		/// Initializes a new instance of the VwLeadGetJoEllenSqlSortBuilder class.
		/// </summary>
		public VwLeadGetJoEllenSortBuilder() : base() { }

		#endregion Constructors

    }    
    #endregion VwLeadGetJoEllenSortBuilder
